...
import com.relevantcodes.extentreports.LogStatus;
	...
	public void GM_Assign_Goal_to_Emp_by_HR(String UserName,String Password,String GoalPlan,String GoalType,String GoalName,String SearchName,String WorkerName,String ProcessName,String ToSelectGoalName) throws TestException,InterruptedException
	{
		...
		report.log(LogStatus.INFO, "Step 22. Click the New Goal list item");
		...
		report.log(LogStatus.INFO, "Step 33. Select the Process");
