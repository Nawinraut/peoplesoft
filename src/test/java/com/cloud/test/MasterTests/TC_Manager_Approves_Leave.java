/**
 Test Name: TC_Manager_Approves_Leave
 Created By: Ciber
...
public class TC_Manager_Approves_Leave extends BaseWebTest  {
SoftAssert sAssert;

public WebDriverWait wdwait;

@Test(dataProvider = "CloudDataProviderUtil_HCM", dataProviderClass = DataProviderRepository.class, description = "This test is to Manager Approves Leave")	
public void Manager_Applies_Leave(String UserName,String Password,String LeaveType,String Frequency,String SelectStartDate,String SelectReason,String Comments,String TeamMemberName,String StartDate) throws TestException,InterruptedException, TestException
{
	...
	//sAssert.assertTrue(SeleniumUtils.swithToWindow(driver, "Action Required: Approval of Ciber_Annual_Type Absence Request"));
	sAssert.assertTrue(SeleniumUtils.swithToWindow(driver, "Approval of Ciber_Annual_Type Absence Request"));
	
	report.log(LogStatus.INFO, "Step 7. Click the Approve button");
	ApproveOrRejectPage objAORobj=new ApproveOrRejectPage(driver,report);
	objAORobj.clickApproveButton();
