/**
 ...
 Modified Date:
End Date:
 Test Description: This script is used for to set performance goals for an Employee by Manager
...
import com.relevantcodes.extentreports.LogStatus;
	...
	public class PM_Set_PerformanceGoals_for_an_Emp_by_Manager extends BaseWebTest  {
	SoftAssert sAssert;
	public WebDriverWait wdwait;

	@Test(dataProvider = "CloudDataProviderUtil_HCM_Phase2", dataProviderClass = DataProviderRepository.class, description = "This test is to set performance goals for an Employee by Manager")	
	public void PM_Set_PerfGoals_to_Emp_by_Mgr(String UserName,String Password,String ReviewPeriod,String EmpName,String SearchCompName, String CompetencyName,String GoalType,String GoalName) throws TestException,InterruptedException
	{
		...
		objPerf.selectGoalType(GoalType);
		
		report.log(LogStatus.INFO, "Step 20. Click in the Goal Name List");
		objPerf.clickGoalNameList();
		
		report.log(LogStatus.INFO, "Step 21. Enter the desired information into the Goal Name field");
		if(GoalName != "")
		{
			objPerf.selectGoalName(GoalName);
			report.log(LogStatus.PASS, "Step 21.1.Goal Name is selected successfully");
		}
		else
		{
			report.log(LogStatus.FAIL, "Step 21.1.Value of Goal Name is not selected");
		}
		...
		report.log(LogStatus.INFO, "Step 24. Click the Save button.");
		objPerf.clickSaveButton();
		...
		report.log(LogStatus.INFO, "Step 27. Click the Yes button.");
		objPerf.clickYesButton();
