...
public class FA_DepreciateAssets extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void FA_Depreciate_Assets(String UserName,String Password)throws TestException,InterruptedException, TestException {
