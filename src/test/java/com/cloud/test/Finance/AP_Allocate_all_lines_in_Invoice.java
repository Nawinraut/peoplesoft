...
public class AP_Allocate_all_lines_in_Invoice extends BaseWebTest{
	...
	public void AP_Allocate_All_lines_Inv(String UserName,String Password,String BusinessUnit,String Supplier,String Number,String Amount,String TypeCell1,String TypeCell2,String TypeCell3,String AmountCell1,String AmountCell2,String AmountCell3,String DistributionCombinationValue1,String DistributionCombinationValue2,String FileType,String CategoryType,String FileName,String TextArea,String URL)throws TestException,InterruptedException, TestException {
...
if (FileType.equalsIgnoreCase("File")) {
			...
			report.log(LogStatus.INFO, "Step 16. Click on Attachments Button");
			objCrtInvoice.isAttachmentsBtnDisplayed();
			objCrtInvoice.clickAttachmentsButton();
			
			report.log(LogStatus.INFO, "Step 16.1 Select File Type from dropdown");
			objCrtInvoice.isfileTypeDisplayed();
			objCrtInvoice.selectfileType(FileType);
						
			report.log(LogStatus.INFO, "Step 16.2 Select Catagory from dropdown");
			objCrtInvoice.isCatagoryDisplayed();
			objCrtInvoice.selectCatagory(CategoryType);
			
			report.log(LogStatus.INFO, "Step 16.3 Click on Browse button and upload the file");
			...
			report.log(LogStatus.INFO, "Step 16.4 Click on Ok button");
			...
			report.log(LogStatus.INFO, "Step 16.3 Enter Text in File Name or URL field");
		...
		int LineNumber=1;
		report.log(LogStatus.INFO, "Step 17. Select Type List from Line1");
		if(TypeCell1!= "") {
			objCrtInvoice.selectDistCombinationType(LineNumber,TypeCell1);
			report.log(LogStatus.PASS, "Step 17.1.Selected given Type from the list is "+TypeCell1);
		}else {
			report.log(LogStatus.FAIL, "Step 17.1.Given Type from the list is not selected");
		}
		
		report.log(LogStatus.INFO, "Step 18.1. Click in the Distribution Combination Amount field. Enter the desired information into the Distribution Combination field. Enter a valid value");
		if(AmountCell1!= "") {
			
			objCrtInvoice.enterDistCombinationAmount(LineNumber,AmountCell1);
			report.log(LogStatus.PASS, "Step 18.1.Distribution Combination Amount is entered successfully: "+AmountCell1);
		}else {
			report.log(LogStatus.FAIL, "Step 18.1.Distribution Combination Amount is not entered");
		}
		
		//String DistributionCombinationValue1 ="10.01.01.01.01.01.671970.00.000.0000";
		
		report.log(LogStatus.INFO, "Step 19.1. Click in the Distribution Combination Value field. Enter the desired information into the Distribution Combination field. Enter a valid value");
		if(DistributionCombinationValue1!= "") {
			
			objCrtInvoice.enterDistCombinationValue(LineNumber,DistributionCombinationValue1);
			report.log(LogStatus.PASS, "Step 19.1.Distribution Combination Value is entered successfully: "+DistributionCombinationValue1);
		}else {
			report.log(LogStatus.FAIL, "Step 19.1.Distribution Combination Value is not entered");
		}
		...
		LineNumber=2;
		report.log(LogStatus.INFO, "Step 20. Select Type List from Line2");
		if(TypeCell2!= "") {
			objCrtInvoice.clickDistCombinationType(LineNumber);
			objCrtInvoice.selectDistCombinationType(LineNumber,TypeCell2);
			report.log(LogStatus.PASS, "Step 20.1.Selected given Type from the list is "+TypeCell2);
		}else {
			report.log(LogStatus.FAIL, "Step 20.1.Given Type from the list is not selected");
		}
		
		report.log(LogStatus.INFO, "Step 21. Click in the Distribution Combination Amount field. Enter the desired information into the Distribution Combination field. Enter a valid value");
		if(AmountCell2!= "") {
			
			objCrtInvoice.enterDistCombinationAmount(LineNumber,AmountCell2);
			report.log(LogStatus.PASS, "Step 21.1.Distribution Combination Amount is entered successfully: "+AmountCell2);
		}else {
			report.log(LogStatus.FAIL, "Step 21.1.Distribution Combination Amount is not entered");
		}
		...
		// Line Number 3
		LineNumber=3;
		report.log(LogStatus.INFO, "Step 23. Select Type List from Line2");
		if(TypeCell3!= "") {
			objCrtInvoice.clickDistCombinationType(LineNumber);
		...
		if(AmountCell3!= "") {
			...
			report.log(LogStatus.PASS, "Step 24.1.Distribution Combination Amount is entered successfully: "+AmountCell2);
		}else {
		...
		report.log(LogStatus.INFO, "Step 26. Click on All Lines list");
		objCrtInvoice.clickAllLinesList();
		
		report.log(LogStatus.INFO, "Step 27. Click on Confirmation Ok button");
		objCrtInvoice.clickAllLinesConfOk();
		
		report.log(LogStatus.INFO, "Step 28. Click on Actions Menu");
		objCrtInvoice.clickActionsMenu();
		
		report.log(LogStatus.INFO, "Step 29. Click on Velidate list");
		objCrtInvoice.selectValidateMenu();
		
		report.log(LogStatus.INFO, "Step 30. Click on Infirmation Ok button");
		objCrtInvoice.clickInformationOkButton();
		
		report.log(LogStatus.INFO, "Step 31. Click on Save and Close button");
