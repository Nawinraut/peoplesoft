...
public class AR_Create_a_Miscellaneous_Receipt extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to Create a Miscellaneous Receipt")
	public void AR_Miscellaneous_Receipt(String UserName,String Password,String ReceiptType,String BusinessUnit,String ReceiptMethod,String ReceiptNumber,String EnteredAmount,String ReceivablesActivity,String BankName,String BranchName,String BankAccount)throws TestException,InterruptedException, TestException {
