...
public class FA_AddAsset extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void FA_Add_Asset(String UserName,String Password,String AssetType,String Major,String Minor,String Description,String Cost,String Location,String AssetNumber,String ClassCode,String EmployeeName)throws TestException,InterruptedException, TestException {
		...
		if(Major != "")
		{
			...
			objAssets.clickMajorSearchIcon();
			objAssets.clickMajorSearchLink();
			objAssets.enterValue(Major);
			objAssets.clickMajor_MinorSearchButton();
			objAssets.selectMajor(Major);
			//objAssets.clickMajorOkButton();
		...
		if(Minor != "")
		{
			...
			objAssets.clickMinorSearchIcon();
			objAssets.clickMinorSearchLink();
			objAssets.enterValue(Minor);
			objAssets.clickMajor_MinorSearchButton();
			objAssets.selectEvent(Minor);
			objAssets.clickMajor_MinorOkButton();
