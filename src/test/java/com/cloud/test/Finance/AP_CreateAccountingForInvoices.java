/**
 Test Name: TC_CreateAccountingForInvoices
 Created By: Ciber
 Creation Date:May 16,2018
 Modified By:
 Modified Date:
 Test Description: This script is used for to Create Accounting for Invoices
...
public class AP_CreateAccountingForInvoices extends BaseWebTest{
	
	SoftAssert sAssert;

	public WebDriverWait wdwait;

	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Create Accounting for Invoices")	
	public void AP_Create_Accounting_Invoice(String UserName,String Password,String SubledgerApplication,String Ledger,String ProcessCategory) throws TestException,InterruptedException, TestException{
