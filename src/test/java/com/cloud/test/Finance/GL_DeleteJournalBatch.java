...
public class GL_DeleteJournalBatch extends BaseWebTest{
	...
	public void GL_Delete_Journal_Batch(String UserName,String Password,String Journal,String JournalBatch,String AccountingPeriod)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 12. Click on Journals Batch Action menu");
		objeditJournal.isJournalBatchActionMenuDisplayed();
		objeditJournal.clickJournalBatchActionMenu();
		
		report.log(LogStatus.INFO, "Step 13. Click on Delete from Journals Batch Action menu");
		...
		report.log(LogStatus.INFO, "Step 14. Click on Yes Button");
