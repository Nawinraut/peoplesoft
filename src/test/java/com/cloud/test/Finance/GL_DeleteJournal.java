...
public class GL_DeleteJournal extends BaseWebTest{
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Delete the Journal")
	public void GL_Delete_Journal(String UserName,String Password,String Journal,String JournalBatch,String AccountingPeriod)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 12. Click on Journals Action menu");
		objeditJournal.isJournalActionMenuDisplayed();
		objeditJournal.clickJournalActionMenu();
		
		report.log(LogStatus.INFO, "Step 13. Click on Delete option from Journals Action menu");
		objeditJournal.isJournalDeleteListDisplayed();
		objeditJournal.clickJournalDeleteList();
		
		report.log(LogStatus.INFO, "Step 14. Click on Delete Confirmation Yes button");
		objeditJournal.isDeleteConfYesButtonDisplayed();
		objeditJournal.clickDeleteConfYesButton();
		
		report.log(LogStatus.INFO, "Step 15. Click on Save Menu");
		objeditJournal.isSaveMenuDisplayed();
		objeditJournal.clickSaveMenu();
		
		report.log(LogStatus.INFO, "Step 16. Click on Save and Close option from Save Menu");
		objeditJournal.isSaveAndCloseListDisplayed();
		objeditJournal.clickSaveAndCloseList();
