...
public class GL_Closing_General_Ledger_accounting_period extends BaseWebTest{
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass = DataProviderRepository.class, description = "This test is to Manage Accounting Periods for Payables to Close the Period")
	public void Cloud_Closing_Acc_Periods(String UserName,String Password,String Ladger,String PeriodToClose)throws TestException,InterruptedException, TestException {
		...
		if(PeriodToClose != "") {
			...
			report.log(LogStatus.FAIL, "Step 8.1.Given Closing Period from the list is not selected");
		}
