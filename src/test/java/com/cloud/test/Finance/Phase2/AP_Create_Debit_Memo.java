...
public class AP_Create_Debit_Memo extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass = DataProviderRepository.class, description = "This test is How to Create Manual Debit Memo")
	public void Cloud_Create_Debit_Memo(String UserName,String Password,String BusinessUnit,String Supplier,String Dr_Memo_Number,String Amount,String Type,String PaymentTerms,String Action,String Invoice_Number,String Amount_Cell)throws TestException,InterruptedException, TestException {
