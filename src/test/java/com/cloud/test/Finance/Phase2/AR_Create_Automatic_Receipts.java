...
public class AR_Create_Automatic_Receipts extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass =DataProviderRepository.class, description = "This test is How to Create Automatic Receipts by Receivables Specialist")
	public void Cloud_Create_Automatic_Receipts(String UserName,String Password,String BusinessUnit,String ReceiptMethod,String FromDueDate,String ToDueDate,String CustomerName,String CustomerNameCell)throws TestException,InterruptedException, TestException {
