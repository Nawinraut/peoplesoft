...
public class GL_Process_Revaluation extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass =DataProviderRepository.class, description = "This test is How to Process Revaluation")
	public void Cloud_Process_Revaluation(String UserName,String Password,String LedgerorLedgerSet,String Revaluation,String AccountingPeriod)throws TestException,InterruptedException, TestException {
