...
public class AP_Allocate_all_lines_in_Invoice extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass = DataProviderRepository.class, description = "This test is How to Allocate All Lines in Invoice")
	public void Cloud_Allocate_All_lines_Inv(String UserName,String Password,String BusinessUnit,String Supplier,String Number,String Amount,String TypeCell1,String TypeCell2,String TypeCell3,String AmountCell1,String AmountCell2,String AmountCell3,String DistributionCombinationValue1,String DistributionCombinationValue2,String Company,String Region,String Country,String Service,String Location,String Department,String NaturalAccountSearch1,String NaturalAccountLine1,String NaturalAccountSearch2,String NaturalAccountLine2,String Intercompany,String FundSource,String Future1)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 24.Click on Allocate Menu");
		objCrtInvoice.clickAllocateMenu();
		
		report.log(LogStatus.INFO, "Step 25. Click on All Lines list");
		objCrtInvoice.clickAllLinesList();
		
		report.log(LogStatus.INFO, "Step 26. Click on Confirmation Ok button");
		objCrtInvoice.clickAllLinesConfOk();
		
		report.log(LogStatus.INFO, "Step 27. Click on Actions Menu");
		objCrtInvoice.clickActionsMenu();
		
		report.log(LogStatus.INFO, "Step 28. Click on Velidate list");
