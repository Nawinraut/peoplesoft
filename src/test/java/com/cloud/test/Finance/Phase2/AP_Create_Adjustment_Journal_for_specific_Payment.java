...
public class AP_Create_Adjustment_Journal_for_specific_Payment extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass =DataProviderRepository.class, description = "This test is How to Create Adjustment Journal for Specific Payment")
	public void Cloud_Adj_Journal_Spec_Payment(String UserName,String Password,String Ledger,String JournalCategory,String Description,String CompletionStatus,String LegalEntity,String AccountingValue1,String AccountingValue2,String AccountingClass1,String AccountingClass2,String Debit,String Credit)throws TestException,InterruptedException, TestException {
