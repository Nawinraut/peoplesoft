...
public class AP_CreditMemoInvoice  extends BaseWebTest{
	...
	public void AP_Credit_Memo_Invoice(String UserName,String Password,String BusinessUnit,String Supplier,String Cr_Memo_Number,String Amount,String Type,String PaymentTerms,String Action,String Invoice_Number,String Amount_Cell,String BusinessUnit_Payment,String DisbursementBankAccount,String PaymentProcessProfile)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 22. Click on Correct Check-Box and Enter the desired information into the Amount field");
		...
		report.log(LogStatus.INFO, "Step 23. Click on Apply button");
		objCrtInvoice.isAppyBtnDisplayed();
		objCrtInvoice.clickApplyButton();
		
		report.log(LogStatus.INFO, "Step 24. Click on Ok button");
		objCrtInvoice.isAccountOkButtonDisplayed();
		objCrtInvoice.clickOkButton();
		
		report.log(LogStatus.INFO, "Step 25. Click on Invoice Actions Menu");
		objCrtInvoice.isActionsMenuDisplayed();
		objCrtInvoice.clickActionsMenu();
		
		report.log(LogStatus.INFO, "Step 26. Select on Validate Invoice Actions Menu");
		objCrtInvoice.isValidateMenuDisplayed();
		objCrtInvoice.selectValidateMenu();
		
		report.log(LogStatus.INFO, "Step 27. Click on Information Ok Button");
		objCrtInvoice.isInformationOkBtnDisplayed();
		objCrtInvoice.clickInformationOkButton();
		
		report.log(LogStatus.INFO, "Step 28. Click on Save And Close Button");
		objCrtInvoice.isSaveAndCloseBtnDisplayed();
		objCrtInvoice.clickSaveAndCloseButton();
		
		report.log(LogStatus.INFO, "Step 29. Click on Information Ok Button");
		objCrtInvoice.isInformationOkBtnDisplayed();
		objCrtInvoice.clickInformationOkButton();
