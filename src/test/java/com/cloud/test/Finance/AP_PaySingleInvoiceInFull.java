...
public class AP_PaySingleInvoiceInFull extends BaseWebTest  {
SoftAssert sAssert;
...
@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Pay Single Invoice in Full")
	...
	public void AP_Pay_Single_Inv_Full(String UserName,String Password,String BusinessUnit,String InvoiceNumber,String PartyName,String PaymentProcessProfile,String BankAccount,String PaymentDocument)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 20. Select Bank Account");
		objEditInvoice.SelectBankAccount(BankAccount);
		...
		objEditInvoice.clickPaymentProProfileSearchIcon();
		objEditInvoice.selectPaymentProProfileValue(PaymentProcessProfile);
		
		report.log(LogStatus.INFO, "Step 20. Select Payment Document");
		objEditInvoice.SelectPaymentDocument(PaymentDocument);
		...
		objEditInvoice.isInformationConfOkBtnDisplayed();
		objEditInvoice.clickInformationConfOkButton();
