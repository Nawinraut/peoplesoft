...
public class AR_Adjust_Transactions extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to Adjust Transaction")
	public void AR_Adjust_Transactions(String UserName,String Password,String BusinessUnit,String TransactionNumber,String ReceivablesActivity,String AdjustmentType,String AdjustmentReason)throws TestException,InterruptedException, TestException {
