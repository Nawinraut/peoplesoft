...
public class AP_Allocate_Specific_lines_in_Invoice extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is How to Allocate Specific Lines in Invoice")
	public void AP_Allocate_Spec_Lines_Inv(String UserName,String Password,String BusinessUnit,String Supplier,String Number,String Amount,String TypeCell1,String TypeCell2,String TypeCell3,String AmountCell1,String AmountCell2,String AmountCell3,String DistributionCombinationValue1,String DistributionCombinationValue2,String FreightAmount,String FreightLineNumber)throws TestException,InterruptedException, TestException {
