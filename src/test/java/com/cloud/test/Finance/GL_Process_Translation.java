...
public class GL_Process_Translation extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to do Translation")
	public void GL_Process_Translation(String UserName,String Password,String TargetCurrency,String AccountingPeriod,String BalancingSegment)throws TestException,InterruptedException, TestException {
