...
public class AP_GeneratePayablesInvoiceRegister extends BaseWebTest{
	...
	public void AP_Generate_Pay_Inv_register(String UserName,String Password,String Name,String NameCell,String BusinessUnit,String SupplierName,String SelectFromEnteredDate,String SelectToEnteredDate,String AccountingPeriod)throws TestException,InterruptedException, TestException {
		...
		objScheduled.selectPaymentFileRegisterCell_Succeeded(ProcessId);
