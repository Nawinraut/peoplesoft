/**
Test Name: TC_ManageAccountingPeriodsForPayablesToClose
 Created By: Ciber
 Creation Date:May 28,2018
 Modified By:
 Modified Date:
 Test Description: This script is used for to Manage Accounting Periods for Payables to Close the Period
...
public class AP_ManageAccountingPeriodsForPayablesToClose extends BaseWebTest{
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Manage Accounting Periods for Payables to Close the Period")
	public void AP_Manage_Acc_Periods_Close(String UserName,String Password,String Ladger,String PeriodToClose)throws TestException,InterruptedException, TestException {
		...
		objEditAccount.selectEditAccountingPeriodStatuses(PeriodToClose);
		
		report.log(LogStatus.INFO, "Step 9. Click on Close Period button");
		objEditAccount.isClosePeriodButtonDisplayed();
		objEditAccount.clickClosePeriodButton();
