...
public class GL_ReverseJournal extends BaseWebTest{
	...
	public void GL_Reverse_Journal(String UserName,String Password,String Journal,String JournalBatch,String AccountingPeriod,String ReversalPeriod)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 21.1 Select on Reversal period value");
		objeditJournal.selectkReversalPeriodValue(ReversalPeriod);
		
		/*report.log(LogStatus.INFO, "Step 21.1. Click on Reversal period Search link");
		...
		report.log(LogStatus.INFO, "Step 21.2. Enter Reversal period value");
		objeditJournal.isReversalPeriodNameDisplayed();
		objeditJournal.enterReversalPeriodName(ReversalPeriod);
		
		report.log(LogStatus.INFO, "Step 21.3. Click on Reversal period Search Button");
		objeditJournal.isPeriodSearchButtonDisplayed();
		objeditJournal.clickPeriodSearchButton();
		
		report.log(LogStatus.INFO, "Step 21.4. Select on Reversal period value");
		objeditJournal.isReversalPeriodNameValueDisplayed();
		objeditJournal.clickReversalPeriodNameValue();
		
		report.log(LogStatus.INFO, "Step 21.5. Click on Reversal period Ok Button");
		...
		//objeditJournal.clickshowLessLink();
				
		report.log(LogStatus.INFO, "Step 22. Click on Save Button");
		objMngJournal.isSaveButtonDisplayed();
		objMngJournal.clickSaveButton(); 
		
		
		report.log(LogStatus.INFO, "Step 23. Click on  Journal Actions Menu");
		objeditJournal.isJournalActionMenuDisplayed();
		objeditJournal.clickJournalActionMenu();
		
		
		report.log(LogStatus.INFO, "Step 24. Click on  Revers Link");
