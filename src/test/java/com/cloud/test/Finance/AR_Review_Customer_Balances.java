...
public class AR_Review_Customer_Balances extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to Review Customer Balances")
	public void AR_Review_Customer_Balances(String UserName,String Password,String Customer)throws TestException,InterruptedException, TestException {
