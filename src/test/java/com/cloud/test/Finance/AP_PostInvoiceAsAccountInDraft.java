/**
 Test Name: TC_PostInvoiceAsAccountInDraft
 Created By: Ciber
 Creation Date:May 8,2018
 Modified By:
 Modified Date:
 Test Description: This script is used for to Post Invoice as Account in Draft
 Prerequisite: Test data should be proper before running this script(Invoice number should be validated but not posted)
 */
...
public class AP_PostInvoiceAsAccountInDraft extends BaseWebTest  {
SoftAssert sAssert;
public WebDriverWait wdwait;

@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Post Invoice as Account in Draft")

	public void AP_Post_Inv_Account_Draft(String UserName,String Password,String BusinessUnit,String InvoiceNumber,String PartyName)throws TestException,InterruptedException, TestException {
		...
		objMngInvoice.selectPostInvoiceEvent(InvoiceNumber);
		...
		report.log(LogStatus.INFO, "Step 17. Select on Account in Draft item from Invoice Actions Menu");
		objMngInvoice.isAccountInDraftMenuDisplayed();
		objMngInvoice.selectAccInDraftMenu();
		
		report.log(LogStatus.INFO, "Step 18. Click on Confirmation Ok button");
		objMngInvoice.isConfOkButtonDisplayed();
		objMngInvoice.clickConfOkButton();
