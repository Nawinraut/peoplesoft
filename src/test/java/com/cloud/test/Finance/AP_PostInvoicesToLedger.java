...
public class AP_PostInvoicesToLedger extends BaseWebTest  {
SoftAssert sAssert;
...
public void AP_Post_Invoices_To_Ledger(String UserName,String Password,String SubledgerApplication,String Ledger,String ProcessCategory) throws TestException,InterruptedException, TestException{
	...
	objSubRequest.clickSubmissionNotesField();
