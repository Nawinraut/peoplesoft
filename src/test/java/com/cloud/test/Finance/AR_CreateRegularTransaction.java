...
import com.cloud.pageobjects.Finance.ReviewTransaction_InvoicePage;
import com.cloud.util.DataProviderRepository;
import com.relevantcodes.extentreports.LogStatus;

public class AR_CreateRegularTransaction extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void AR_CreateRegular_Transaction(String UserName,String Password,String BusinessUnit,String TransactionSource,String BilltoName,String CustomerCell,String Description,String Quantity,String UnitPrice)throws TestException,InterruptedException, TestException {
		...
		ReviewTransaction_InvoicePage  objReviewTransaction= objEdtTransaction.clickCompleteAndReviewListt();
		
		report.log(LogStatus.INFO, "Step 20. Click on Action Menu");
		objReviewTransaction.isActionsMenuDisplayed();
		objReviewTransaction.clickActionsMenu();
		
		report.log(LogStatus.INFO, "Step 21. Click on Post to Ladger in Action Menu");
		objReviewTransaction.isPostLedgerMenuDisplayed();
		objReviewTransaction.selectPostLedgerMenu();
		
		report.log(LogStatus.INFO, "Step 22. Click on Ok Button in Confirmation Pop-up");
		objReviewTransaction.isConfOkButtonDisplayed();
		objReviewTransaction.clickConfOkButton();
		
		report.log(LogStatus.INFO, "Step 23. Click on Save Menu");
		objReviewTransaction.isSaveMenuDisplayed();
		objReviewTransaction.clickSaveMenu();
		
		report.log(LogStatus.INFO, "Step 24. Click on Save and Close in Save Menu");
		objReviewTransaction.isSaveAndCloseDisplayed();
		objReviewTransaction.clickSaveAndCloseList();
		
		report.log(LogStatus.INFO, "Step 25. Click on Ok Button in Information Pop-up");
		objReviewTransaction.isInfoOkButtonDisplayed();
		objReviewTransaction.clickInfoOkButton();
