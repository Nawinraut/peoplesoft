...
public class AP_Create_Manual_Payment extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to Create Manual Payment by Payables Supervisor")
	public void AP_Create_Manual_Payment(String UserName,String Password,String BusinessUnit,String Supplier,String SupplierCell,String DisbursementBankAccount,String PaymentProcessProfile,String InvoiceNumber)throws TestException,InterruptedException, TestException {
