...
public class AP_CancelLineInInvoice extends BaseWebTest{
	...
	public void AP_Cancel_Line_in_Invoice(String UserName,String Password,String BusinessUnit,String InvoiceNumber,String PartyName)throws TestException,InterruptedException, TestException {
		...
		objEditInvoice.clickExpandLinesIcon();*/
