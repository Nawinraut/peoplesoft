...
public class GL_Create_Cross_currency_Journal extends BaseWebTest{
	...
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to Create Cross Currency Journal")
	public void GL_Crt_Cross_currency_Jrnl(String UserName,String Password,String JournalBatch,String JournalBatchDescription,String Journal,String JournalDescription,String Category,String Currency,String Account1,String Debit,String Account2,String Credit,String ConversionDate,String ConversionRateType,String ConversionRate)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 15. Select Conversion Rate Type from list");
		if(ConversionRateType != "")
		{
			objCrtJrnl.clickConversionRateTypeSearchIcon();
			objCrtJrnl.clickConversionRateTypeSearchLink();
			objCrtJrnl.enterConversionRateTypeName(ConversionRateType);
			objCrtJrnl.clickConversionRateTypeSearchButton();
			objCrtJrnl.clickConversionRateTypeValue(ConversionRateType);
			objCrtJrnl.clickConversionRateTypeOkButton();
			report.log(LogStatus.PASS, "Step 15.1.Selected given Conversion Rate Type from the list is "+ConversionRateType);
		}
		else
		{
		...
		report.log(LogStatus.INFO, "Step 15. Click in the Conversion Rate field. Enter the desired information into the Conversion Rate field. Enter a valid value");
		if(ConversionRate != "")
		{
			objCrtJrnl.enterConversionRate(ConversionRate);
			report.log(LogStatus.PASS, "Step 15.1.Conversion  Rate is entered successfully: "+ConversionRate);
		}
		else
		{
			report.log(LogStatus.FAIL, "Step 15.1.Conversion Rate is not entered");
		}
