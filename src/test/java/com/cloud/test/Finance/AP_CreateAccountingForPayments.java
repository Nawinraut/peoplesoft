...
public class AP_CreateAccountingForPayments  extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void AP_Create_Accounting_Payment(String UserName,String Password,String SubledgerApplication,String Ledger,String ProcessCategory) throws TestException,InterruptedException, TestException{
