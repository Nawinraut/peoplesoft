...
public class GL_PostJournalOnline extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void GL_Post_Journal_Online(String UserName,String Password,String Journal,String JournalBatch,String AccountingPeriod)throws TestException,InterruptedException, TestException {
