...
public class AP_StandardInvoiceWithAttachment extends BaseWebTest{
	...
	public void AP_Standard_Inv_Attachment(String UserName,String Password,String BusinessUnit,String Supplier,String Number,String Amount,String FileType,String CategoryType,String FileName,String TextArea,String URL,String AmountCell,String Company,String Region,String Country,String Service,String Location,String Department,String NaturalAccount,String Intercompany,String FundSource,String Future1,String DistributionCombinationField1)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 19. Click on Expand Lines icon");
		...
		report.log(LogStatus.INFO, "Step 15. Click in the Invoice Lines Distribution Combination field. Enter the desired information into the Invoice Lines Distribution Combination field. Enter a valid value");
		if(DistributionCombinationField1 != "")
		{
			objCrtInvoice.enterDistCombinationValue(1, DistributionCombinationField1);
			report.log(LogStatus.PASS, "Step 15.1.Invoice Lines Distribution Combination is entered successfully: "+DistributionCombinationField1);
		}
		else
		{
			report.log(LogStatus.FAIL, "Step 15.1.Invoice Lines Distribution Combination is not entered");
		}
