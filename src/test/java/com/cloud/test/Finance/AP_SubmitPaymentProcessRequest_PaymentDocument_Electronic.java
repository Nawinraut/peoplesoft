...
public class AP_SubmitPaymentProcessRequest_PaymentDocument_Electronic extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void AP_Submit_Pmnt_Prcs_Request_Ele(String UserName,String Password,String Name,String PayThroughDate,String BusinessUnit,String PartyName,String DisbursementBankAccount,String PaymentDocument,String PaymentProcessProfile)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 24. Select Payment Process Profile");
		objSubPmntRequest.isCreatePaymentFilesImmediatelyDisplayed();
		objSubPmntRequest.clickCreatePaymentFilesImmediatelyCheckBox();
		
		report.log(LogStatus.INFO, "Step 25. Click on Submit button");
