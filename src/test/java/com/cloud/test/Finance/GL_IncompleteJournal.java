/**
 Test Name: TC_IncompleteJournal
 Created By: Ciber
 Creation Date:May 4,2018
 Modified By:
 Modified Date:
 Test Description: This script is used for to Create Incomplete Journal
...
public class GL_IncompleteJournal extends BaseWebTest{
	
	//String newJournal="1234";
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to create Incomplete Journal")
	public void GL_Incomplete_Journal(String UserName,String Password,String JournalBatch,String Description,String Journal,String JournalDescription,String Category,String D_Company,String D_Region,String D_Country,String D_Service,String D_Location,String D_Department,String D_NaturalAccount,String D_Intercompany,String D_FundSource,String D_Future1,String Debit,String C_Company,String C_Region,String C_Country,String C_Service,String C_Location,String C_Department,String C_NaturalAccount,String C_Intercompany,String C_FundSource,String C_Future1,String Credit,String AccountField1,String AccountField2)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 31. Select Natural Account from list");
		...
		objCrtJournal.clickAccountSearchButton();
		SeleniumUtils.delay(3000);
		report.log(LogStatus.INFO, "Step 60. Select Natural Account from list");
		...
		report.log(LogStatus.INFO, "Step 70. Click on Save Manu");
		SeleniumUtils.delay(5000);
		objCrtJournal.isSaveMenuDisplayed();
		objCrtJournal.clickSaveManu();
		
		report.log(LogStatus.INFO, "Step 71. Click on SaveAndClose button");
		//SeleniumUtils.delay(5000);
		objCrtJournal.isSaveAndCloseDisplayed();
		objCrtJournal.clickSaveAndCloseButton();
		SeleniumUtils.delay(5000);
		...
		objJournals1.isManageJournalLinkDisplayed(); 
		...
		report.log(LogStatus.INFO, "Step 17. Click on Complete button");
		objEdit.clickCompleteButton();
		
		objEdit.clickSaveButton();*/
		
		/*report.log(LogStatus.INFO, "Step 72. Click on Sign Out link to sign out from application");
		objHome.clickImgHome();
		SeleniumUtils.delay(5000);
		...
		report.log(LogStatus.INFO, "Step 73. Click on Confirm button to sign out from application");
