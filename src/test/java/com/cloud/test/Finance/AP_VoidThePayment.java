/**
Test Name: TC_VoidThePayment
 Created By: Ciber
 Creation Date:May 22,2018
 Modified By:
 Modified Date:
 Test Description: This script is used for to Void the Payment
...
public class AP_VoidThePayment extends BaseWebTest{
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass = DataProviderRepository.class, description = "This test is to Void the Payment")
	public void AP_Void_The_Payment(String UserName,String Password,String PartyName,String PaymentNumber)throws TestException,InterruptedException, TestException {
		...
		AP_Create_Manual_Payment a = new AP_Create_Manual_Payment();
		...
		report.log(LogStatus.INFO, "Step 17. Select Void from Actions Manu");
		...
		report.log(LogStatus.INFO, "Step 21. Click on Sign Out link to sign out from application");
		objHome.clickImgHome();
		SeleniumUtils.delay(3000);
		objHome.clickUserIcon();
		objHome.clickSignOut();
		
		report.log(LogStatus.INFO, "Step 22. Click on Confirm button to sign out from application");
