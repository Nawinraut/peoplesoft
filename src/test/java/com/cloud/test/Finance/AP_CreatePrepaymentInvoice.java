...
public class AP_CreatePrepaymentInvoice extends BaseWebTest{
	...
	public void AP_Crt_Prepayment_Invoice(String UserName,String Password,String BusinessUnit,String Supplier,String Number,String Amount,String Type,String Amount_Cell,String PaymentProcessProfile,String BankAccount,String PaymentDocument)throws TestException,InterruptedException, TestException {
		...
		report.log(LogStatus.INFO, "Step 26. Select Bank Account");
		objCrtInvoice.SelectBankAccount(BankAccount);
		
		report.log(LogStatus.INFO, "Step 27. Select Payment Process Profile");
		objCrtInvoice.isSelectPaymentProcessProfileDisplayed();
		//objEditInvoice.SelectPaymentProcessProfile(PaymentProcessProfile);
		objCrtInvoice.clickPaymentProProfileSearchIcon();
		objCrtInvoice.selectPaymentProProfileValue(PaymentProcessProfile);
		
		report.log(LogStatus.INFO, "Step 28. Select Payment Document");
		objCrtInvoice.SelectPaymentDocument(PaymentDocument);
		objCrtInvoice.clickPaymentNumber();
		
		report.log(LogStatus.INFO, "Step 29. Click on Submit button");
		objCrtInvoice.isSubmitBtnDisplayed();
		objCrtInvoice.clickSubmitButton();
		
		report.log(LogStatus.INFO, "Step 30. Click on Confirmation Ok button");
