...
public class AP_ReissueThePayment extends BaseWebTest{
	SoftAssert sAssert;
	...
	public void AP_Reissue_The_Payment(String UserName,String Password,String PartyName,String PaymentNumber)throws TestException,InterruptedException, TestException {
		...
		PaymentPage objPayment=objMngPayment.selectPaymentNumberCell(PaymentNumber);
