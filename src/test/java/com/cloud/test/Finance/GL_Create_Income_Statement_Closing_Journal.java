...
import com.cloud.pageobjects.Finance.CreateIncomeStatementClosingJournals_BasicOptionsPage;
import com.cloud.pageobjects.Finance.PeriodClosePage;
import com.cloud.util.DataProviderRepository;
import com.cloud.utils.TestNGListeners;
import com.relevantcodes.extentreports.LogStatus;
@Listeners(TestNGListeners.class)
public class GL_Create_Income_Statement_Closing_Journal extends BaseWebTest{
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	
	@Test(dataProvider = "CloudDataProviderUtil_Finance_Phase2", dataProviderClass =DataProviderRepository.class, description = "This test is How to Create Income Statement Closing Journal")
	public void Cloud_Crt_Income_Exp_Clos_Jrnls(String UserName,String Password,String AccountingPeriod,String ClosingAccount,String Category)throws TestException,InterruptedException, TestException {
		...
		CreateIncomeStatementClosingJournals_BasicOptionsPage objBscOptions=objPrdClose.clickCreateIncomeStatementClosingJournalsLink();
