...
public class AP_ApplyMissingConversionRates extends BaseWebTest{
	...
	public void AP_Apply_Missing_Conv_Rates(String UserName,String Password,String BusinessUnit)throws TestException,InterruptedException, TestException {
