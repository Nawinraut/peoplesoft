...
public class GL_Trial_Balance_Sheet_report extends BaseWebTest{
	
	SoftAssert sAssert;
	public WebDriverWait wdwait;
	
	@Test(dataProvider = "CloudDataProviderUtil_Finance", dataProviderClass =DataProviderRepository.class, description = "This test is How to Submit Trial Balance Report")
	public void GL_Trial_Balance_Sheet_report(String UserName,String Password,String Name,String NameCell,String AccountingPeriod,String AmountType,String Company)throws TestException,InterruptedException, TestException {
