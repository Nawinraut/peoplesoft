...
public class TC_Changing_Martial_Status extends BaseWebTest  {
SoftAssert sAssert;


public WebDriverWait wdwait;

@Test(dataProvider = "CloudDataProviderUtil_HCM", dataProviderClass = DataProviderRepository.class, description = "This test is to Update the Martial Status")	
public void Cloud_BioGraphical_Inforamtion(String UserName,String Password,String FirstName,String LastName,String PhoneNumber,String AddressLine1,String MartialStatus) throws TestException,InterruptedException, TestException
{
	...
	report.log(LogStatus.INFO, "Step 7. Click on Biographical Information icon");
	objPIPage.clickBGInformation();
	
	
	report.log(LogStatus.INFO, "Step 8. Select any Martial status");
	//objPIPage.selectMartialStatus(MartialStatus);
	//objPIPage.selectMartialStatus("Married");
	objPIPage.clickMaritalStatusIconAndSelectStatus(MartialStatus);
	...
	System.out.println(objMyDetails.getMartialStartus());
	sAssert.assertEquals(objMyDetails.getMartialStartus(),MartialStatus,"Actaul and Exepced Martial Status is not matching ");
