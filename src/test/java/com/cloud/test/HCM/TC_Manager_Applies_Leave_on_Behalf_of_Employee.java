...
public void Managr_Leave_Behalf_of_Employee(String UserName,String Password,String LeaveType,String Frequency,String SelectStartDate,String SelectReason,String Comments,String TeamMemberName,String StartDate) throws TestException,InterruptedException, TestException
{
	...
	objMAPobj.clickTypeIconAndSelectType(LeaveType);
