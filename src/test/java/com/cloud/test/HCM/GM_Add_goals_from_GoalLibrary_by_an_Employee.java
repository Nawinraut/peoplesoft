...
import com.relevantcodes.extentreports.LogStatus;
	...
	public void GM_Add_Goals_from_GL_by_Emp(String UserName,String Password,String GoalType,String GoalName) throws TestException,InterruptedException
	{
		...
		report.log(LogStatus.INFO, "Step 7. Click the Add Goal button");
		objgoal.clickAddGoalButton();
		
		report.log(LogStatus.INFO, "Step 8. Click the Library Goal list item");
		objgoal.selectGoalType(GoalType);
		
		report.log(LogStatus.INFO, "Step 9. Click in the Goal Name List");
		objgoal.clickGoalNameList();
		report.log(LogStatus.INFO, "Step 10. Enter the desired information into the Goal Name field");
		if(GoalName != "")
		{
			objgoal.selectGoalName(GoalName);
			report.log(LogStatus.PASS, "Step 10.1.Goal Name is selected successfully");
		}
		else
		{
			report.log(LogStatus.FAIL, "Step 10.1.Value of Goal Name is not selected");
		}
		
		report.log(LogStatus.INFO, "Step 11. Click the Save and Close button.");
		objgoal.clickSaveAndCloseButton();
		
		report.log(LogStatus.INFO, "Step 12. Click the OK button.");
