		...
		String BusinessUnit,String SearchJobText,String JobType) throws TestException,InterruptedException, TestException
{
	...
	report.log(LogStatus.INFO, "Step 9. Click the Hire Date cell.");
	...
	String hireDateParts[] = HireDateDayNumber.split("-");
	String hireMonth  = hireDateParts[0];
	String hireDay  = hireDateParts[1];
	String hireYear = hireDateParts[2];
	report.log(LogStatus.INFO, "Step 11. Click on Hire Date button");
	objNWP.clickHireDateButton();
	report.log(LogStatus.INFO, "Step 11. Enter on Hire Date Year");
	objNWP.SelectYearFromDatePickerHireDate(hireYear);
	report.log(LogStatus.INFO, "Step 11.1. Select From Payment Month");
	objNWP.selectHireDateMonth(hireMonth);
	report.log(LogStatus.INFO, "Step 11.2. Select From Payment Date");
	objNWP.selectHireDate(hireDay);
	...
	if(HireReason != "")
	{
		...
		objNWP.clickHireReasonIconAndSelectReason(HireReason);
	...
	objNWP.SelectLegalEmployerList(LegalEmployer);
	...
	if(Title != "")
	{
		...
		objNWP.clickTitleIconAndSelectTitle(Title);
	...
	if(Gender != "")
	{
		...
		objNWP.clickGenderIconAndSelectGender(Gender);
	...
	if(DOBYear != "")
	{
		...
		objNWP.SelectYearFromDatePickerDOB(DOBYear);
	...
	if(DOBDayNumber != "")
	{
		...
		objNWP.selectDOBDate(DOBDayNumber);
	...
	if(PhoneType != "")
	{
		...
		objNWP.clickPhoneTypeIconAndSelectPhoneType(PhoneType);
	...
	if(MartialStatus != "")
	{
		...
		objNWP.clickMaritalStatusIconAndSelectStatus(MartialStatus);
