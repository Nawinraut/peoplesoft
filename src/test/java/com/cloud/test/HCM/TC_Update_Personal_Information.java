...
public void Update_Personal_Details(String UserName,String Password,String FirstName,String LastName,String PhoneNumber,String AddressLine1,String MartialStatus,String BloodType,String SearchText,String Department) throws TestException,InterruptedException, TestException
{
	...
	objPIPage.clickBloodTypeIconAndSelectBloodType(BloodType);
