...
@Test
public class DynamicTestNGSuite_Finance_Phase2 {
		...
		try
		{
			...
			for(int i=1;i<=excel.getRowCount("Master_Tests");i++)
			{
                ...
                if(execFlag.equalsIgnoreCase("Y"))
                {
                	...
                	testngxml.createTestXml("TempSuitetag", "FinanceModuleTests","com.cloud.test.Finance.Phase2.",excel.getCellData("Master_Tests", i, 1),excel.getCellData("Master_Tests", i, 3));
                }
			}
		}
		catch(IOException e)
