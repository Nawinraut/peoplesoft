...
public class TerminatePage extends BasePageObject {
	...
	private WebElement iconRecForRehireSearch;
	...
	@FindBy(xpath = "//a[contains(@id,'selectOneChoice1::drop')]")
	private WebElement iconReasonSearch;
		...
		public void clickConfirmatioDialog(String strYesOrNO)
		{
		 ...
		 public void clickRecommendedforRehireIconAndSelectRehire(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconRecForRehireSearch));
			 iconRecForRehireSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Rehire Search icon");
			 WebDriverWait wait = new WebDriverWait(driver, 50);
		 ...
		 public void clickReasonIconAndSelectReason(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconReasonSearch));
			 iconReasonSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Reason Search icon");
			 WebDriverWait wait = new WebDriverWait(driver, 50);
			   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
			   SeleniumUtils.delay(2000);
			   eventLink.click(); 
