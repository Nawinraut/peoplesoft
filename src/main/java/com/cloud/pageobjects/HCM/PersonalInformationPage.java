...
public class PersonalInformationPage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//img[contains(@id,'i5:1:cil1::icon')]")
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,'ei3:0:einputText17::content')]")
	...
	//Newly added
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'soc4::drop')]")
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'socBloodType::drop')]")
	private WebElement iconBloodTypeSearch;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'INFO:0:MAnt2:1:SP1:r1:0:cb2::popEl')]")
	private WebElement listNewContacts;
	
	@FindBy(how=How.XPATH, using = "//*[contains(@id,':1:SP1:sdi2::icon')]")
	//*[@id="_FOpt1:_FOr1:0:_FOSrPER_HCMPEOPLETOP_FUSE_PER_INFO:0:MAnt2:1:SP1:sdi2::icon"]
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'phoneType1::drop')]")
	private WebElement iconPhoneTypeSearch;
	
	@FindBy(how=How.XPATH, using = "//input[contains(@id,'countryNameId::content')]")
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'countryNameId::lovIconId')]")
	private WebElement iconCountryCodeSearch;
	...
	private List<WebElement> colcount;
	 ...
	 @SuppressWarnings("unchecked")
		...
		public void clickPhoneTypeIconAndSelectPhoneType(String eventName) throws InterruptedException{	
			 ...
			 report.log(LogStatus.PASS, "Clicked on Phone Type Search icon");
		...
		public void selectCountryCodeList(String eventName) {	
			 inputCountryCode.clear();
			 inputCountryCode.click();
			 inputCountryCode.sendKeys(eventName);
		 ...
		 public void clickCountryCodeicon()
		 {
			 iconCountryCodeSearch.click();
				//SeleniumUtils.delay(5000);
			 wdwait.until(ExpectedConditions.visibilityOf(lnkSearch));
	 ...
	 public void selectNewContactsList(String strType)
	 {
		 ...
		 if(strType.equalsIgnoreCase("Phone"))
		 {
			...
			driver.findElement(By.xpath("//td[contains(text(),'Phone')]")).click();
		 }
		 ...
		 else if(strType.equalsIgnoreCase("Other Communication Accounts"))
		 {
			...
			driver.findElement(By.xpath("//td[contains(text(),'Other Communication Accounts')]")).click();
		 }
		 else
		 {
...
/*	 public void selectType(String strType)
	 ...
	 {
		 lnkSearch.click();
		 wdwait.until(ExpectedConditions.visibilityOf(txtCountry));
		 //SeleniumUtils.delay(3000);
		 this.getScreenDetails();
	 }
	 ...
	 public void clickBGInformation() throws TestException{
		    ...
		    this.getScreenDetails("After Biographical image click");
		  }
	 ...
	 public void selectMartialStatus(String strMartialStaus){
	    	...
	    	SeleniumUtils.delay(3000);
	    	this.getScreenDetails("After selecting martail status");
	    }
	 ...
	 public void clickBloodTypeIconAndSelectBloodType(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconBloodTypeSearch));
		 iconBloodTypeSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Blood Type Search icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
