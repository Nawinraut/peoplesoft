...
public class TransferPage extends BasePageObject {
	...
	@FindBy(xpath = "//a[contains(@id,'pt1:ap1:selectOneChoice2::drop')]")
	private WebElement iconTransferReasonSearch;
	...
	@FindBy(xpath = "//a[contains(@id,'pt1:ap1:Locat2:0:soc1::drop')]")
	private WebElement iconWAHSearch;
	...
	private List<WebElement> rowcount;
		 ...
		 public void clickTransferReasonIconAndSelectTransferReason(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconTransferReasonSearch));
			 iconTransferReasonSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Transfer Reason Search icon");
		 ...
		 public void clickWorkAtHomeIconAndSelectWorkAtHome(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconWAHSearch));
			 iconWAHSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Work At Home Search icon");
			 WebDriverWait wait = new WebDriverWait(driver, 50);
			   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='AFPopupMenuPopup']//li[text()= '"+eventName+"']")));	   
			   SeleniumUtils.delay(2000);
			   eventLink.click(); 
		 ...
		 public void enterBuildingInfo(String strBuilding)
		 {
			 ...
			 txtBuilding.sendKeys(Keys.TAB);
			 //SeleniumUtils.delay(2000);
			 WebElement eventText = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(" //*[contains(@id,'0:d1::yes')]")));
			 this.getScreenDetails("Entered Building Info");
			 if (eventText.isDisplayed())
			 {
				 eventText.click();
			 }
