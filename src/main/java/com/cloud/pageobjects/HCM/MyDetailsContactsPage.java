...
public class MyDetailsContactsPage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'MAnt2:1:SP1:r2:1:t1:cb3')]")
	private WebElement btnNewContacts;
	
	//@FindBy(how=How.XPATH, using = "//*[contains(@id,'MAnt2:1:SP1:r2:1:t1:selectBooleanRadio1::content')]")
	//@FindBy(how=How.XPATH, using = "//label[text()='Add a new person']//div[@class='x1c6']")
	@FindBy(how=How.XPATH, using = "//table[contains(@id,'t1:selectBooleanRadio1')]//label[@class='x1cc']")
	private WebElement selectAddNewPerson;
	
	//@FindBy(how=How.XPATH, using = "//*[contains(@id,'MAnt2:1:SP1:r2:1:t1:sbr2::content')]")
	@FindBy(how=How.XPATH, using = "//table[contains(@id,'t1:sbr2')]//label[@class='x1cc']")
	...
	@FindBy(how=How.XPATH, using = "//label[contains(@id,'sbc21::contentlabelTextId')]")
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'soc3::drop')]")
	private WebElement iconRelationshipSearch;
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,'soc4::content')]")
	private WebElement txtPhoneTypeSearch;
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id, 'soctest::drop')]")
	...
	private WebElement errorDOB;
	 ...
	 public void clickRelationshipIconAndSelectRelationship(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconRelationshipSearch));
		 iconRelationshipSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Relationship Search icon");
	 ...
	 public void clickPhoneTypeIconAndSelectPhoneType(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(txtPhoneTypeSearch));
		 txtPhoneTypeSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Phone Type field");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='AFPopupMenuPopup']//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
		   SeleniumUtils.delay(5000);
		   report.log(LogStatus.PASS, "Selected from list is: "+eventName);
	 ...
	 public void selectNewPersonRadio()
	 {
		 
		 if(selectAddNewPerson.isDisplayed()) {
			 System.out.println("Radio button has been displayed");
		 }
		 
		 if(selectAddNewPerson.isEnabled()) {
			 System.out.println("Radio button has been enabled");
		 }
		 
		 
		 //Commented for because radio button is not selecting
		 if(selectAddNewPerson.isSelected()) {
