...
public class ChangeManagerPage extends BasePageObject {
	...
	@FindBy(xpath = "//a[contains(@id,'pt1:ap1:soc2::drop')]")
	private WebElement iconChangeReasonSearch;
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'selectOneChoice1::drop')]")
	private WebElement iconLineManagerSearch;
	...
	private List<WebElement> rowcount;
		...
		public void clickChangeReasoniconAndSelectReason(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconChangeReasonSearch));
			 iconChangeReasonSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Change Reason Search icon");
		...
		public void clicLineManagericonAndSelectLineManager(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconLineManagerSearch));
			 iconLineManagerSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Line Manager Search icon");
			 WebDriverWait wait = new WebDriverWait(driver, 50);
			   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='AFPopupMenuPopup']//li[text()= '"+eventName+"']")));	   
			   SeleniumUtils.delay(2000);
			   eventLink.click(); 
		 ...
		 public void selectManagerName(String strManagerName)
			{	
			 System.out.println("entered text is "+strManagerName);
