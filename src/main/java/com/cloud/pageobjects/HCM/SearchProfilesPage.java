...
public class SearchProfilesPage extends BasePageObject {
	...
	//@FindBy(how=How.XPATH, using = "_FOpt1:_FOr1:0:_FOSritemNode_career_profiles:0:_FOTRaT:0:RAtl7']")
	@FindBy(xpath = "//a[contains(.,'Manage Content Items')]")
	private WebElement lnkManageContentItems;
	
	@FindBy(xpath = "//a[contains(.,'Manage Content Types')]")
	private WebElement lnkManageContentType;
	
	@FindBy(xpath = "//a[contains(.,'Manage Educational Establishments')]")
