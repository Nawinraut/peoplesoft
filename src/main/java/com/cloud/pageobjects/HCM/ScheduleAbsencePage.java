...
public class ScheduleAbsencePage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:soc1::drop')]")
	private WebElement iconTypeSearch;
	
	@FindBy(how=How.XPATH, using = "//select[contains(@id,'TIME:0:MAnt2:1:pt1:soc2::content')]")
	private WebElement selectFrequency;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:soc2::drop')]")
	private WebElement iconFrequencySearch;
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:soc121::drop')]")
	...
	public void selectStartDate(String noOfDays)
	{
	 ...
	 public void clickTypeIconAndSelectType(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconTypeSearch));
		 iconTypeSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Type Search icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
		   wdwait.until(ExpectedConditions.visibilityOf(iconFrequencySearch));
		   //SeleniumUtils.delay(5000);
...
//	    	SeleniumUtils.delay(5000);
	 ...
	 public void clickFrequencyIconAndSelectFrequency(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconFrequencySearch));
		 iconFrequencySearch.click();
		 report.log(LogStatus.PASS, "Clicked on Frequency Search icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
