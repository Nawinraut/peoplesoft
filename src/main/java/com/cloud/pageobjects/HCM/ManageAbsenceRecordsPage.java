...
public class ManageAbsenceRecordsPage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'soc1::drop')]")
	...
	@FindBy(how=How.XPATH, using = "//button[contains(@id,'pt1:AP1:AT1:d3::ok')]")
	...
	@FindBy(how=How.XPATH, using = "//tr[@id='_FOpt1:_FOr1:0:_FOSrPER_HCMPEOPLETOP_FUSE_MY_TEAM:0:MAnt2:1:pt1:AP1:AT1:r1:1:r1:1:sbc2']//label[@class='x1cd']")
...
//		 SeleniumUtils.delay(5000);
	 ...
	 public void clickTypeIconAndSelectType(String eventName) throws InterruptedException{	
		 ...
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   ...
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
		   wdwait.until(ExpectedConditions.visibilityOf(checkSingleDay));
		   //SeleniumUtils.delay(5000);
