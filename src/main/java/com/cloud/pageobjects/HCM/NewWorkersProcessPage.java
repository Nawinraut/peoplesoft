...
public class NewWorkersProcessPage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:SP1:inputDate1::glyph')]")
    private WebElement btnHireDate;
 
	 @FindBy(how=How.XPATH, using = "//select[contains(@id,'pt1:SP1:inputDate1::pop::cd::mSel::content')]")
	    private WebElement selectHireDateMonth;
	 
	 @FindBy(how=How.XPATH, using = "//input[contains(@id,'pt1:SP1:inputDate1::pop::cd::ys::content')]")
	    private WebElement txtHireDateYear;
	
	 @FindBy(how=How.XPATH, using = "//table[contains(@id,'pt1:SP1:inputDate1::pop::cd::cg')]")
	    private WebElement tableHireDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:SP1:inputDate1::pop::cd::ys::decrement')]")
	    private WebElement btnPrevHireDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:SP1:inputDate1::pop::cd::ys::increment')]")
	    private WebElement btnNextHireDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'r1:0:id3::glyph')]")
		private WebElement imageDOBPicker;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'pt_r1:0:id3::glyph')]")
	    private WebElement btnDOB;
	 
	 @FindBy(how=How.XPATH, using = "//select[contains(@id,'id3::pop::cd::mSel::content')]")
	    private WebElement selectDOBMonth;

	 @FindBy(how=How.XPATH, using = "//table[contains(@id,'id3::pop::cd::cg')]")
	    private WebElement tableDOBDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'pt_r1:0:id3::pop::cd::ys::decrement')]")
	    private WebElement btnPrevDOB;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'pt_r1:0:id3::pop::cd::ys::increment')]")
	    private WebElement btnNextDOB;
	
	@FindBy(how=How.XPATH, using = "//select[contains(@id,'r1:0:pt1:SP1:selectOneChoice2::content')]")
	private WebElement selHireReason;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:SP1:selectOneChoice2::drop')]")
	private WebElement iconHireReason;
	
	@FindBy(how=How.XPATH, using = "//select[contains(@id,'r1:0:r1:0:i1:2:selectOneChoice4::content')]")
	private WebElement selTitle;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'selectOneChoice4::drop')]")
	private WebElement iconTitleSearch;
	
	@FindBy(how=How.XPATH, using = "//select[contains(@id,'r1:0:soc3::content')]")
	private WebElement selGender;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'r1:0:soc3::drop')]")
	private WebElement iconGenderSearch;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'r1:0:pt1:SP1:selectOneChoice3::lovIconId')]")
	private WebElement selLegEmp;
	
	@FindBy(how=How.XPATH, using = "//input[contains(@id,'pt1:SP1:selectOneChoice3::content')]")
	private WebElement inputLegEmployer;
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,'it20::content')]")
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,':inputComboboxListOfValues27::content')]")
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,':inputComboboxListOfValues25::content')]")
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,':inputComboboxListOfValues28::content')]")
	private WebElement txtPostalCode;
	
	@FindBy(how=How.XPATH, using = "//*[contains(@id,':MAnt2:1:pt1:pt_r1:1:pt1:SP1:Perso2:0:pt_r1:0:AT1:_ATp:create::icon')]")
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'soc2::drop')]")
	private WebElement iconMartialStatusSearch;
	
	//@FindBy(how=How.XPATH, using = "//select[contains(@id,'ATp:table1:0:soc1::content')]")
	@FindBy(xpath = "//select[contains(@name,'ATp:table1:0:soc1')]")
	private WebElement selectPhoneType;
	
	@FindBy(xpath = "//a[contains(@id,'_ATp:table1:0:soc1::drop')]")
	private WebElement iconPhoneTypeSearch;
	...
	@FindBy(xpath = "//input[contains(@name,'ATp:table1:0:it3')]")
	...
	private List<WebElement> rowcount;
	 ...
	 public void clickMaritalStatusIconAndSelectStatus(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconMartialStatusSearch));
		 iconMartialStatusSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Marital Status icon");
	 ...
	 public void clickPhoneTypeIconAndSelectPhoneType(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconPhoneTypeSearch));
		 iconPhoneTypeSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Marital Status icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
	 ...
	 public boolean isHireDateBtnDisplayed(){
	    	return btnHireDate.isDisplayed();
	    	
	    }
	    public void clickHireDateButton(){	    	
	    	btnHireDate.click();
	    	 wdwait.until(ExpectedConditions.visibilityOf(selectHireDateMonth));
	    	//SeleniumUtils.delay(3000);
	    	report.log(LogStatus.PASS, "Clicked on Hire Date Button");
	    }
	   
	   // Select From Date Month from Calander
	    public void selectHireDateMonth(String fromMonth){
	    	Select objSelect = new Select(selectHireDateMonth);
	    	objSelect.selectByVisibleText(fromMonth);
	    	 //wdwait.until(ExpectedConditions.visibilityOf(calendarFromInvoiceDt));
	    	SeleniumUtils.delay(2000);
	    	report.log(LogStatus.PASS, "Selected Hire Date Month is: "+fromMonth);
	    } 
	   
	   public boolean isHireDateMonthDisplayed(){
		   return selectHireDateMonth.isDisplayed();
	   }
	   
	// Select From Date Month from Calander
	    public void SelectYearFromDatePickerHireDate(String fromYear){
	    	
	    	String HireYearLbl=txtHireDateYear.getAttribute("title");
	    	
	    	while (fromYear != HireYearLbl)
	        {
	            if (Integer.parseInt(fromYear) < Integer.parseInt(HireYearLbl))
	            {
	                btnPrevHireDate.click();
	                String HireYearLbl1=txtHireDateYear.getAttribute("title");
	            ...
	            else
	            {
	                ...
	                btnNextHireDate.click();
	                String HireYearLbl2=txtHireDateYear.getAttribute("title");
	   ...
	   public boolean isHireDateYearDisplayed(){
		   return selectHireDateMonth.isDisplayed();
	   }
	   
	   // Select From Payment Date
	   public void selectHireDate(String fromDate)
		{
			...
			for (WebElement cell:dates)
			  {
			   ...
			   if (date.equalsIgnoreCase(fromDate))
			   {
			     cell.click();
				   SeleniumUtils.delay(2000);
				   report.log(LogStatus.PASS, "Selected Hire Date is "+fromDate);
				   break;
	 ...
	 public void clickHireReasonIconAndSelectReason(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconHireReason));
		 iconHireReason.click();
		 report.log(LogStatus.PASS, "Clicked on Hire Reason icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
	 ...
	 public void clickTitleIconAndSelectTitle(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconTitleSearch));
		 iconTitleSearch.click();
		 report.log(LogStatus.PASS, "Clicked on title Search icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
	 ...
	 // Select From Payment Date
	   public void selectDOBDate(String fromDate)
		{
			List<WebElement> dates = driver.findElements(By.xpath("//table[contains(@id,'id3::pop::cd::cg')]//td"));  
			for (WebElement cell:dates)
			  {
				String date=cell.getText();
			   if (date.equalsIgnoreCase(fromDate))
			   {
			     cell.click();
				   SeleniumUtils.delay(2000);
				   report.log(LogStatus.PASS, "Selected DOB Date is "+fromDate);
				   break;
	 ...
	 public void clickGenderIconAndSelectGender(String eventName) throws InterruptedException{	
		 wdwait.until(ExpectedConditions.visibilityOf(iconGenderSearch));
		 iconGenderSearch.click();
		 report.log(LogStatus.PASS, "Clicked on Gender Search icon");
		 WebDriverWait wait = new WebDriverWait(driver, 50);
		   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
	 ...
	 public void enterPostalCode(String strZipCode)
	 {
		 ...
		 txtPostalCode.sendKeys(Keys.ENTER);
		 SeleniumUtils.delay(5000);
		 txtPostalCode.click();
	...
	// Select From Date Month from Calander
	    public void SelectYearFromDatePickerDOB(String fromYear){
	    	
	    	String HireYearLbl=txtYear.getAttribute("title");
	    	...
	    	while (fromYear != HireYearLbl)
	        {
	            ...
	            {
	                btnPrevDOB.click();
	                String HireYearLbl1=txtYear.getAttribute("title");
	                //SeleniumUtils.delay(3000);
	                if(Integer.parseInt(fromYear) == Integer.parseInt(HireYearLbl1))
	                {
	                	break;
	            ...
	            else
	            {
	                ...
	                btnNextDOB.click();
	                //SeleniumUtils.delay(3000);
	                String HireYearLbl2=txtYear.getAttribute("title");
	                if(Integer.parseInt(fromYear) == Integer.parseInt(HireYearLbl2))
	                {
	                	break;
	                }
	    	...
	    	report.log(LogStatus.PASS, "Selected DOB Year is: "+fromYear);
	    } 
	...
	//Legal Employer list
	   public void SelectLegalEmployerList(String strLegalEmployer) throws InterruptedException{
		   SeleniumUtils.delay(2000);
		   inputLegEmployer.clear();
		   inputLegEmployer.click();
		   inputLegEmployer.sendKeys(strLegalEmployer);
		   	//inputLegEmployer.sendKeys(Keys.ARROW_DOWN);
		   inputLegEmployer.sendKeys(Keys.ENTER);
		   SeleniumUtils.delay(5000);
		   inputLegEmployer.click();
	    report.log(LogStatus.PASS, "Selected given Legal Employer  is: "+strLegalEmployer);
	   }
	   
	   public boolean isLegEmployerListDisplayed(){
		   return inputLegEmployer.isDisplayed();
		   } 
