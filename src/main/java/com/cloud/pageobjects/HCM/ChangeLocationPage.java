...
public class ChangeLocationPage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:ap1:Locat1:0:soc1::drop')]")
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,'building::content')]")
	...
	@FindBy(how=How.XPATH, using = "//input[contains(@id,':inputText1::content')]")
	...
	private List<WebElement> rowcount;
		...
		public void selectWorkAtHome(String strWorkAtHome)
		{
		 ...
		 public void clickWorkingatHomeiconAndSelectWAH(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconWAHSearch));
			 iconWAHSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Working at Home Search icon");
		...
		public void clickLocationList()
		 ...
		 public void enterBuildingInfo(String strBuilding)
		 {
			 ...
			 SeleniumUtils.delay(2000);
			 report.log(LogStatus.INFO, "BuildingInfo entered successfully "+strBuilding);
		 ...
		 public void enterFloor(String strFloor)
		 {
			...
			/* if (driver.findElement(By.xpath("//*[contains(@id,':r1:0:pt1:ap1:Locat1:0:d1::yes')]")).isDisplayed())
			 ...
			 report.log(LogStatus.INFO, "Floor Info entered successfully "+strFloor);
		 }
