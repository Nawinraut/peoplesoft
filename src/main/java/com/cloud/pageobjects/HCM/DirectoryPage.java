...
public class DirectoryPage extends BasePageObject {
	...
	@FindBy(how=How.XPATH, using = "//img[contains(@id,'cil1::icon')]")
	...
	@FindBy(how=How.XPATH, using = "//div[@id='_FOpt1:_FOr1:0:_FOSrPER_HCMPEOPLETOP_FUSE_DIRECTORY:0:_FOTsr1:1:r1:0:pt1:r4:0:ls1:AT1']")
	private WebElement directoryTable1;
	...
	public void selectWebtableElementDirectory(String strPersonName,String strDeptName)
	{	
		rowcount=(List<WebElement>) directoryTable1.findElements(By.tagName("tr"));
		int rownum=rowcount.size();
		System.out.println("Row Count"+rownum);
		for (int row=1;row<=rownum;row++)
		{
			WebElement cellNametext=driver.findElement(By.xpath(" //div[@id='_FOpt1:_FOr1:0:_FOSrPER_HCMPEOPLETOP_FUSE_DIRECTORY:0:_FOTsr1:1:r1:0:pt1:r4:0:ls1:AT1']//table/tbody/tr["+row+"]/td[3]"));
			String actualText=cellNametext.getText();
			System.out.println("actual text is "+actualText);
			
			WebElement cellDepartmenttext=driver.findElement(By.xpath(" //div[@id='_FOpt1:_FOr1:0:_FOSrPER_HCMPEOPLETOP_FUSE_DIRECTORY:0:_FOTsr1:1:r1:0:pt1:r4:0:ls1:AT1']//table/tbody/tr["+row+"]/td[4]"));
			String actualDeptText=cellDepartmenttext.getText();
			System.out.println("actual text is "+actualDeptText);
			...
			if(actualText.contains(strPersonName)  && actualDeptText.contains(strDeptName))
			{
				System.out.println("found proper person name and department name");
				report.log(LogStatus.INFO, "Selected Person Name is "+strPersonName+" and department name is "+strDeptName);
				driver.findElement(By.xpath(" //div[@id='_FOpt1:_FOr1:0:_FOSrPER_HCMPEOPLETOP_FUSE_DIRECTORY:0:_FOTsr1:1:r1:0:pt1:r4:0:ls1:AT1']//table/tbody/tr["+row+"]/td[2]")).click();
				SeleniumUtils.delay(5000);
				this.getScreenDetails();
				break;
			}
	 ...
	 public boolean isDisplayed() {
    	 report.log(LogStatus.PASS, "Directory Information Page is Loaded Successfully");
