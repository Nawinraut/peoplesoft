...
//	@FindBy(how=How.XPATH, using = "//*[contains(@id,':SP3:table1:_ATp:table2')]")
	...
	@FindBy(xpath = "//a[contains(.,'Manage Talent Profile')]")
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'AP1:actionsName1::drop')]")
	private WebElement iconActionSearch;
	...
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:ap1:Termi1:0:Action::drop')]")
	private WebElement iconTerminateActionSearch;
	
	@FindBy(how=How.XPATH, using = "//a[contains(@id,'NotificationDate::glyph')]")
    private WebElement btnNotificationDate;
 
	 @FindBy(how=How.XPATH, using = "//select[contains(@id,'NotificationDate::pop::cd::mSel::content')]")
	    private WebElement selectNotificationDateMonth;
	 
	 @FindBy(how=How.XPATH, using = "//input[contains(@id,'NotificationDate::pop::cd::ys::content')]")
	    private WebElement txtNotificationDateYear;
	
	 @FindBy(how=How.XPATH, using = "//table[contains(@id,'NotificationDate::pop::cd::cg')]")
	    private WebElement tableNotificationDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'NotificationDate::pop::cd::ys::decrement')]")
	    private WebElement btnPrevNotificationDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'NotificationDate::pop::cd::ys::increment')]")
	    private WebElement btnNextNotificationDate;
	 

	@FindBy(how=How.XPATH, using = "//a[contains(@id,'TerminationDate::glyph')]")
    private WebElement btnTerminationDate;
 
	 @FindBy(how=How.XPATH, using = "//select[contains(@id,'TerminationDate::pop::cd::mSel::content')]")
	    private WebElement selectTerminationDateMonth;
	 
	 @FindBy(how=How.XPATH, using = "//input[contains(@id,'TerminationDate::pop::cd::ys::content')]")
	    private WebElement txtTerminationDateYear;
	
	 @FindBy(how=How.XPATH, using = "//table[contains(@id,'TerminationDate::pop::cd::cg')]")
	    private WebElement tableTerminationDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'TerminationDate::pop::cd::ys::decrement')]")
	    private WebElement btnPrevTerminationDate;
	 
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'TerminationDate::pop::cd::ys::increment')]")
	    private WebElement btnNextTerminationDate;
	...
	@FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:sp1:tt1:submit')]")
//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_workforce_management_person_management:0:MAt2:1:AP1:SPsb2']/a
	...
	//@FindBy(xpath = "//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_workforce_management_person_management:0:MAt2:1:SP1:menu4']")
	@FindBy(xpath = "//*[contains(@id,':SP1:menu4')]")
	private WebElement selAddContentMenu;
	
	@FindBy(xpath = "//a[contains(@title,'Search: Name')]")
	private WebElement selName;
	
	@FindBy(xpath = "//select[contains(@name,':SP1:r1:1:t1:0:selectOneChoice8')]")
	private WebElement selProficiency;
	
	@FindBy(xpath = "//select[contains(@name,':SP1:r1:1:t1:0:selectOneChoice4')]")
	...
	@FindBy(how=How.XPATH, using = "//label[@class='x1cd']")
	...
	private List<WebElement> rowcount;
		...
		public void clickUpdateList()
		 {
			...
			// wdwait.until(ExpectedConditions.visibilityOf(selectAction));
			 wdwait.until(ExpectedConditions.visibilityOf(iconActionSearch));
		...
		public void clickNameList()
		 ...
		 public void selectAddContentMenu(String strAddContent)
		 {
		    	...
		    	SeleniumUtils.delay(2000);*/
			 	...
			 	WebElement addContentList = driver.findElement(By.xpath("//*[contains(@id,':SP1:menu4::ScrollContent')]"));
		 ...
		 public void selectName(String strName)
		 {
			 	selName.click();
			 	SeleniumUtils.delay(2000);
			 	this.getScreenDetails("Name List clicked");
			 	//td[contains(.,'Written Communication')])[2]
			 	driver.findElement(By.xpath("//span[contains(.,'"+strName+"')]")).click();
			 	//driver.findElement(By.xpath("(//td[contains(.,'"+strName+"')])[2]")).click();
		    	SeleniumUtils.delay(2000);
		...
		public void clickContinueButton()
		{
		 ...
		 public void clickActionIconAndSelectAction(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconActionSearch));
			 iconActionSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Action Search icon");
			 WebDriverWait wait = new WebDriverWait(driver, 50);
			   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
			   SeleniumUtils.delay(2000);
			   eventLink.click(); 
			   SeleniumUtils.delay(5000);
		 ...
		 public void clickTerminateActionIconAndSelectAction(String eventName) throws InterruptedException{	
			 wdwait.until(ExpectedConditions.visibilityOf(iconTerminateActionSearch));
			 iconTerminateActionSearch.click();
			 report.log(LogStatus.PASS, "Clicked on Terminate Action Search icon");
			 WebDriverWait wait = new WebDriverWait(driver, 50);
			   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[text()= '"+eventName+"']")));	   
			   SeleniumUtils.delay(2000);
			   eventLink.click(); 
		 ...
		 public boolean isNotificationDateBtnDisplayed(){
		    	return btnNotificationDate.isDisplayed();
		    	
		    }
		    public void clickNotificationDateButton(){	    	
		    	btnNotificationDate.click();
		    	 wdwait.until(ExpectedConditions.visibilityOf(selectNotificationDateMonth));
		    	//SeleniumUtils.delay(3000);
		    	report.log(LogStatus.PASS, "Clicked on Notification Date Button");
		    }
		   
		   // Select From Date Month from Calander
		    public void selectNotificationDateMonth(String fromMonth){
		    	Select objSelect = new Select(selectNotificationDateMonth);
		    	objSelect.selectByVisibleText(fromMonth);
		    	 //wdwait.until(ExpectedConditions.visibilityOf(calendarFromInvoiceDt));
		    	SeleniumUtils.delay(2000);
		    	report.log(LogStatus.PASS, "Selected Notification Date Month is: "+fromMonth);
		    } 
		   
		   public boolean isHireDateMonthDisplayed(){
			   return selectNotificationDateMonth.isDisplayed();
		   }
		   
		// Select From Date Month from Calander
		    public void SelectYearFromDatePickerNotificationDate(String fromYear){
		    	SeleniumUtils.delay(5000);
		    	
		    	String HireYearLbl=txtNotificationDateYear.getAttribute("title");
		    	
		    	while (fromYear != HireYearLbl)
		        {
		            if (Integer.parseInt(fromYear) < Integer.parseInt(HireYearLbl))
		            {
		                btnPrevNotificationDate.click();
		                String HireYearLbl1=txtNotificationDateYear.getAttribute("title");
		            ...
		            else
		            {
		                ...
		                btnNextNotificationDate.click();
		                String HireYearLbl2=txtNotificationDateYear.getAttribute("title");
		    	...
		    	report.log(LogStatus.PASS, "Selected Notification Date Month is: "+fromYear);
		    } 
		   
		   public boolean isNotificationDateYearDisplayed(){
			   return selectNotificationDateMonth.isDisplayed();
		   }
		   
		   // Select From Payment Date
		   public void selectNotificationDate(String fromDate)
			{
				List<WebElement> dates = driver.findElements(By.xpath("//table[contains(@id,'NotificationDate::pop::cd::cg')]//td"));  
				for (WebElement cell:dates)
				  {
				   ...
				   if (date.equalsIgnoreCase(fromDate))
				   {
				     cell.click();
					   SeleniumUtils.delay(2000);
					   report.log(LogStatus.PASS, "Selected Notification Date is "+fromDate);
					   break;
		   ...
		   public boolean isTerminationDateBtnDisplayed(){
		    	return btnTerminationDate.isDisplayed();
		    	
		    }
		    public void clickTerminationDateButton(){	    	
		    	btnTerminationDate.click();
		    	 wdwait.until(ExpectedConditions.visibilityOf(selectTerminationDateMonth));
		    	//SeleniumUtils.delay(3000);
		    	report.log(LogStatus.PASS, "Clicked on Termination Date Button");
		    }
		   
		   // Select From Date Month from Calander
		    public void selectTerminationDateMonth(String fromMonth){
		    	Select objSelect = new Select(selectTerminationDateMonth);
		    	objSelect.selectByVisibleText(fromMonth);
		    	 //wdwait.until(ExpectedConditions.visibilityOf(calendarFromInvoiceDt));
		    	SeleniumUtils.delay(2000);
		    	report.log(LogStatus.PASS, "Selected Termination Date Month is: "+fromMonth);
		    } 
		   
		   public boolean isTerminationDateMonthDisplayed(){
			   return selectTerminationDateMonth.isDisplayed();
		   }
		   
		// Select From Date Month from Calander
		    public void SelectYearFromDatePickerTerminationDate(String fromYear){
		    	SeleniumUtils.delay(3000);
		    	String HireYearLbl=txtTerminationDateYear.getAttribute("title");
		    	
		    	while (fromYear != HireYearLbl)
		        {
		            if (Integer.parseInt(fromYear) < Integer.parseInt(HireYearLbl))
		            {
		                btnPrevTerminationDate.click();
		                String HireYearLbl1=txtTerminationDateYear.getAttribute("title");
		                if(Integer.parseInt(fromYear) == Integer.parseInt(HireYearLbl1))
		                {
		                	break;
		                }
		            ...
		            else
		            {
		                ...
		                btnNextTerminationDate.click();
		                String HireYearLbl2=txtTerminationDateYear.getAttribute("title");
		                if(Integer.parseInt(fromYear) == Integer.parseInt(HireYearLbl2))
		                {
		                	break;
		                }
		    	...
		    	report.log(LogStatus.PASS, "Selected Termination Date Month is: "+fromYear);
		    } 
		   
		   public boolean isTerminationDateYearDisplayed(){
			   return selectTerminationDateMonth.isDisplayed();
		   }
		   
		   // Select From Payment Date
		   public void selectTerminationDateDate(String fromDate)
			{
				List<WebElement> dates = driver.findElements(By.xpath("//table[contains(@id,'TerminationDate::pop::cd::cg')]//td"));  
				for (WebElement cell:dates)
				  {
					String date=cell.getText();
				   if (date.equalsIgnoreCase(fromDate))
				   {
				     cell.click();
					   SeleniumUtils.delay(2000);
					   report.log(LogStatus.PASS, "Selected Termination Date is "+fromDate);
					   break;
...
//				SeleniumUtils.delay(10000);
		 ...
		 public void selectRevokeUserAccess(String strAccessType)
		 {
			...
			if(strAccessType.equalsIgnoreCase("After termination"))
			 ...
			 {
				 driver.findElement(By.xpath("//fieldset//div[2]//span[1]//label[1]")).click();
