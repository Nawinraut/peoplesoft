...
public WebDriver driver;
    ...
    private WebElement selectBusinessUnit;
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'payeeNameId::lovIconId')]")
		...
		@FindBy(how=How.XPATH, using = "//select[contains(@id,'AP1:currencyCode2Id::content')]")
	    private WebElement selectPaymentCurrency;
		...
		@FindBy(how=How.XPATH, using = "//div[@class='x1s5']")
	...
	*/
	...
	// Search Link for Party
	   ...
	   public void enterPartyValue(String value) throws InterruptedException{
		   ...
		   SeleniumUtils.delay(2000);
		   report.log(LogStatus.PASS, "Supplier is entered successfully: "+value);
	   }
	...
	// Party Ok button
	 ...
	 //Disbursement Bank Account
	   public void SelectDisbursementBankAccount(String strDisBankAccount) throws InterruptedException{
	    ...
	    selectDisBankAccount.click();
	   	...
	   	wdwait.until(ExpectedConditions.visibilityOf(selectPaymentCurrency));
	   	//SeleniumUtils.delay(5000);
	 ...
	 //Payment Process Profile
	   public void SelectPaymentProcessProfile(String strPProfile) throws InterruptedException{
	   	...
	   	SeleniumUtils.delay(5000);
	    report.log(LogStatus.PASS, "Selected given Payment Process Profile from the list is: "+strPProfile);
	   }
	  ...
	  public boolean isSelectAndAddButtonDisplayed(){
		   return btnSelectandAdd.isDisplayed();
	  } 
	  
	  public boolean isSelectAndAddButtonEnabled(){
		   return btnSelectandAdd.isEnabled();
	  }
		...
		// Save And Close Button
		  ...
		  public void clickSaveAndCloseButton(){
			...
			// fetch Payment Number  
			  public String fetchPaymentNumber(){	
				   this.getScreenDetails("Confirmation Pop-up");
				   String paymentString=lblconfOk.getText();
				   String paymentNumber = paymentString.split(" ")[1];
				   //int paymentNumber = Integer.parseInt(paymentString.split(" ")[1]);
				   report.log(LogStatus.PASS, "Payment Number is "+paymentNumber);
