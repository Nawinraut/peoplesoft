...
public class SubmitPaymentProcessRequestPage extends BasePageObject{
	...
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'OuGroupRadio:_2')]")
	 @FindBy(how=How.XPATH, using = "//div[contains(@id,'OuGroupRadio::content')]//label[@class=\"x2l\"][text()='Invoice']")
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'partyNameId::lovIconId')]")
		...
		@FindBy(how=How.XPATH, using = "//tr[contains(@id,'MAnt2:1:ap1:sbc1')]//label[@class='x1da']")
	    private WebElement chkBoxCreatePaymentFilesImmediately;
		 ...
		 // Add Row button
			...
			// Select Pay PaymentDocument
			   ...
			   public void SelectPaymentProcessProfile(String strPProfile) throws InterruptedException{
			   	//report.log(LogStatus.PASS, "Select any Category from SelectCategory dropdown");
				   SeleniumUtils.delay(5000);
				   selectPaymentProcProfile.clear();
			   ...
			   // CreatePaymentFilesImmediately Checkbox
			   
			   public boolean isCreatePaymentFilesImmediatelyDisplayed(){
				   return SeleniumUtils.isDisplayed(driver, chkBoxCreatePaymentFilesImmediately, context.getReactTimeout());
			   }
			   
			   public void clickCreatePaymentFilesImmediatelyCheckBox(){	
				   SeleniumUtils.delay(5000);
				   chkBoxCreatePaymentFilesImmediately.click();
				   //SeleniumUtils.delay(3000);
				   report.log(LogStatus.PASS, "Clicked on Create PaymentFiles Immediately Checkbox");   
			   }
