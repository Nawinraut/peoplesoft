...
public class CreateIncomeStatementClosingJournals_BasicOptionsPage extends BasePageObject{
	public WebDriver driver;
	 ...
	 public WebDriverWait wdwait; 
		...
		*/
	    ...
	    public CreateIncomeStatementClosingJournals_BasicOptionsPage(WebDriver driver, ExtentTest report) throws TestException {
		     super(report);
			 this.driver=driver; 
