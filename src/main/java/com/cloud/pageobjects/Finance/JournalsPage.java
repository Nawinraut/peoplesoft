...
public class JournalsPage extends BasePageObject {
	    ...
	    @FindBy(how=How.XPATH,using="//a[contains(.,'Run AutoReverse')]")
		private WebElement lnkRunAutoReverse;
	    
	    @FindBy(how=How.XPATH,using="//a[contains(.,'Generate General Ledger Allocations')]")
		private WebElement lnkGenerateGeneralLedgerAllocations;
		...
		*/
	    ...
	    public AutoReverseJournals_BasicOptionsPage clickRunAutoReverseLink()throws TestException{
	    	//JavascriptExecutor js = (JavascriptExecutor)driver;
	    	//js.executeScript("arguments[0].click();", lnkRunAutoReverse);
	    	lnkRunAutoReverse.click();
	    	report.log(LogStatus.PASS, "Clicked on Run Auto Reverse Link");
	    	return new AutoReverseJournals_BasicOptionsPage(driver,report);
	    }
	    
	    public GenerateAllocations_BasicOptionsPage clickGenerateGeneralLedgerAllocationsLink()throws TestException{
	    	lnkGenerateGeneralLedgerAllocations.click();
	    	report.log(LogStatus.PASS, "Clicked on Generate General Ledger Allocations Link");
	    	return new GenerateAllocations_BasicOptionsPage(driver,report);
	    }
