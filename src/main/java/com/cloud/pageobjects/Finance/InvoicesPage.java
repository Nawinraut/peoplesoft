...
public class InvoicesPage extends BasePageObject{
	...
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'FOTRaT:0:RAtl6')]")
	 @FindBy(how=How.XPATH, using = "//a[contains(.,'Validate Invoices')]")
	 ...
	 @FindBy(how=How.XPATH, using = "//a[contains(.,'Initiate Approval Workflow')]")
	    private WebElement lnkInitiateApprovalWorkflow;
	 ...
	 public WebDriverWait wdwait; 
		...
		*/
	    ...
	    public void clickTasksButton(){
	    	...
	    	//btnTasks.click();
	    	wdwait.until(ExpectedConditions.visibilityOf(lnkInitiateApprovalWorkflow));
	    			report.log(LogStatus.PASS, "Clicked on Tasks Button");
	    	/*if(wdwait.until(ExpectedConditions.visibilityOf(lnkCreateinvoice)) != null) {
	    		report.log(LogStatus.PASS, "Clicked on Tasks Button");
	    	}else if(wdwait.until(ExpectedConditions.visibilityOf(lnkInitiateApprovalWorkflow)) != null) {
	    		report.log(LogStatus.PASS, "Clicked on Tasks Button");
	    	}*/
	   ...
	   //
	    ...
	    public boolean isInitiateApprovalWorkflowLinkDisplayed(){ 
	    	return SeleniumUtils.isDisplayed(driver,  lnkInitiateApprovalWorkflow, context.getReactTimeout());
	    }
	    
	    public InitiateApprovalWorkflow_SubmitRequestPage clickInitiateApprovalWorkflowLink()throws TestException{
	    	lnkInitiateApprovalWorkflow.click();
	    	report.log(LogStatus.PASS, "Clicked on Initiate Approval Workflow Link");
	    	return new InitiateApprovalWorkflow_SubmitRequestPage(driver,report);
	    }	
