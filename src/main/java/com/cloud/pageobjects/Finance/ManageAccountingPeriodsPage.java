...
public class ManageAccountingPeriodsPage extends BasePageObject{
    ...
    private WebElement tblLedger;
	 ...
	 // Select Ledger from Table
		   public void selectTableLadger(String strLedger)
			{
		        ...
		        while(i.hasNext()) {
		            ...
		            if(anchor.getText().contains(strLedger)) {
		                ...
		                report.log(LogStatus.PASS, "Clicked on Cell: "+strLedger);
		                break;
		            }
		        }
		   ...
		   //Select Ledger cell in Table
		   
		   public EditAccountingPeriodStatusesPage selectTableLadgerCell(String strLedger) throws TestException
			{
			   
				List<WebElement> anchors = driver.findElements(By.xpath("//a[contains(@id,'_ATTp:tt1:1:treeCommandLink')]"));
		        ...
		        return new EditAccountingPeriodStatusesPage(driver,report);
			  }
