...
public class ExpenseReportPage extends BasePageObject{
	...
	@FindBy(xpath = "//h1[contains(.,'Expense Report Approval')]")
	...
	// @FindBy(xpath = "//*[@id='ctb4']")
	 ...
	 public WebDriverWait wdwait; 
		...
		*/
	    ...
	    public ExpenseReportPage(WebDriver driver, ExtentTest report) throws TestException {
		     super(report);
			 this.driver=driver; 
		    ...
		    //driver.switchTo().frame(driver.findElement(By.xpath("//*[@id='_adfvdlg']")));
		     ...
		     if (!isDisplayed()) 
		     {
		        ...
		        System.out.println("******************************* Expense Reports Page *****************************");
		...
		public boolean isDisplayed() {
			...
			//return  btnTasks.isDisplayed();
			 ...
			 report.log(LogStatus.PASS, "Expense Report page is Loaded Successfully");
		...
		public Item getScreenDetails(){
		   	...
		   	String projectPath = System.getProperty("user.dir");    	
		   	String fullprojectPath = projectPath+"/report/"+xyz;
		   	report.log(LogStatus.INFO, "<a href='"+fullprojectPath+"'><span class='label info'>Expense Report Page</span></a>");
		   	return new Item(xyz);
	   }
}
