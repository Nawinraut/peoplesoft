...
public class CreateBankStatementTransactions_BasicOptionsPage extends BasePageObject{
	public WebDriver driver;
	
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'_ATTRIBUTE3_ATTRIBUTE3::content')]")
	    private WebElement selectBankAccount;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'_ATTRIBUTE4_ATTRIBUTE4::content')]")
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'paramDynForm_ATTRIBUTE11::glyph')]")
	    private WebElement btnFromStatementEndDt;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'paramDynForm_ATTRIBUTE11::pop::cd::mSel::content')]")
	    private WebElement selectFromStatementEndMonth;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'paramDynForm_ATTRIBUTE11::pop::cd::cg')]")
	    private WebElement tbleFromStatementEndDt;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'paramDynForm_ATTRIBUTE12::glyph')]")
	    private WebElement btnToStatementEndDt;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'paramDynForm_ATTRIBUTE12::pop::cd::mSel::content')]")
	    private WebElement selectToStatementEndMonth;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'paramDynForm_ATTRIBUTE12::pop::cd::cg')]")
	 ...
	 public CreateBankStatementTransactions_BasicOptionsPage(WebDriver driver, ExtentTest report) throws TestException {
	     super(report);
		 this.driver=driver; 
...
// Bank  Account
	...
	// click on From Statement End Date button
	   ...
	   public void selectFromStatementEndDate(String fromDate)
		{
			List<WebElement> dates = driver.findElements(By.xpath("//*[contains(@id,'paramDynForm_ATTRIBUTE11::pop::cd::cg')]//td"));  
	...
	// click on To Statement End Date button
	   ...
	   public void selectToStatementEndDate(String toDate)
		{
			List<WebElement> dates = driver.findElements(By.xpath("//*[contains(@id,'paramDynForm_ATTRIBUTE12::pop::cd::cg')]//td"));  
			for (WebElement cell:dates)
			  {
				String date=cell.getText();
