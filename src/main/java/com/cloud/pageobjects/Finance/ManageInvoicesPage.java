...
public class ManageInvoicesPage extends BasePageObject{
	public WebDriver driver;
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:q1:value40::lovIconId')]|//*[contains(@id,'ap1:q1:value50::lovIconId')]")
	...
	// menu invoice Action
	 ...
	 @FindBy(how=How.XPATH, using = "//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_payables_payables_invoices:0:MAnt2:1:pm1:r1:0:ap1:r7:1:me1']|//*[@id='_FOpt1:_FOr1:0:_FONSr2:0:MAnt2:1:pm1:r1:0:ap1:r7:1:me1']")
	 ...
	 @FindBy(how=How.XPATH, using = "\r\n" + 
	 		"//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_payables_payables_invoices:0:MAnt2:1:pm1:r1:0:ap1:r7:1:cm1']|//*[@id='_FOpt1:_FOr1:0:_FONSr2:0:MAnt2:1:pm1:r1:0:ap1:r7:1:cm1']")
...
// Save and Close button
	 ...
	 //Select Event (select given text from dropdown)
	   public void selectEvent(String eventName) throws InterruptedException { 
		 ...
		 // WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[text()='"+eventName+"']")));
		   SeleniumUtils.delay(2000);
		   eventLink.click(); 
		   SeleniumUtils.delay(5000);
