...
public class CreateReceiptPage extends BasePageObject{
	...
	public WebDriver driver;
	 ...
	 @FindBy(how=How.XPATH, using = "//select[contains(@id,'ap1:receiptType::content')]")
	    private WebElement selectReceiptType;
	 
	 @FindBy(how=How.XPATH, using = "//input[contains(@id,'ap1:activityId::content')]")
	...
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:receiptMethodId::content')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:receiptMethodId::content')]|//*[contains(@id,'ap1:receiptMethodNameId::content')]")
	...
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:receiptNumberId::content')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:receiptNumberId::content')]|//*[contains(@id,'ap1:it1::content')]")
	    private WebElement txtReceiptNumber;
	 
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:amountId::content')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:amountId::content')]|//*[contains(@id,'ap1:amount::content')]")
	    private WebElement txtEnteredAmount;
	 
	 @FindBy(how=How.XPATH, using = "//select[contains(@id,'ap1:currencyCode')]")
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:cbsave1')]")
	 ...
	 public WebDriverWait wdwait; 
		...
		*/
	    ...
	    public CreateReceiptPage(WebDriver driver, ExtentTest report) throws TestException {
		     ...
		     if (!isDisplayed()) 
		     {
		        ...
		        System.out.println("******************************* Create  Receipt Page *****************************");
	  ...
	  //BusinessUnit list
		   public void SelectBusinessUnit(String strBusinessUnit) throws InterruptedException{
		   	...
		   	String strBU=selectBusinessUnit.getText();
		   	if(strBU =="") {
		 ...
		 // Receipt Method
		   ...
		   public void SelectReceiptMethod(String strReceiptMethod) throws InterruptedException{
			   ...
			   selectReceiptMethod.click();
			    ...
			    report.log(LogStatus.PASS, "Selected given Receipt Method  is: "+strReceiptMethod);
			   }
	   ...
	   // Bank Name
		...
		//ReceiptType list
			   public void SelectReceiptType(String strReceiptType) throws InterruptedException{
			   Select objSelect=new Select(selectReceiptType);
			   objSelect.selectByVisibleText(strReceiptType);
			    report.log(LogStatus.PASS, "Selected given Receipt Type is: "+strReceiptType);
			    this.getScreenDetails();
			   }
			   
			   public boolean isReceiptTypeDisplayed(){
				   return selectReceiptType.isDisplayed();
				   } 
			   
			// Receivables  Activity
			   
			   public void SelectstrReceivablesActivity(String strReceivablesActivity) throws InterruptedException{
				   selectReceivablesActivity.click();
				   selectReceivablesActivity.sendKeys(strReceivablesActivity);
				   selectReceivablesActivity.sendKeys(Keys.ENTER);
				   selectReceivablesActivity.click();
				   	SeleniumUtils.delay(2000);
				    report.log(LogStatus.PASS, "Selected given strReceivables Activity  is: "+strReceivablesActivity);
				   }
		...
		// Receipt Number field
			   ...
			   public void enterReceiptNumber(String strReceiptNumber){
				   ...
				   report.log(LogStatus.PASS, "Receipt Number is entered successfully: "+strReceiptNumber);
			   }
	   ...
	   // Entered Amount field
			   ...
			   public void selectCurrencyList(){
				   String strCrncy="USD - US Dollar";
				   selectCurrency.click();
				   String strCurrency = selectCurrency.getText();
				   if(strCurrency == "") {
					   Select objSelect=new Select(selectCurrency);
					   objSelect.selectByVisibleText(strCrncy);
		   ...
		   @Override
			public boolean isDisplayed() {
				...
				//return  btnTasks.isDisplayed();
				 ...
				 report.log(LogStatus.PASS, "Create Receipt page is Loaded Successfully");
			...
			public Item getScreenDetails(){
			   	...
			   	String projectPath = System.getProperty("user.dir");    	
			   	String fullprojectPath = projectPath+"/report/"+xyz;
			   	report.log(LogStatus.INFO, "<a href='"+fullprojectPath+"'><span class='label info'>Create Receipt Page</span></a>");
			   	return new Item(xyz);
		   } 
