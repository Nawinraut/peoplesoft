...
public class EditJournalPage extends BasePageObject{
	...
	@FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:showMoreHeader')]")
	    private WebElement lnkShowMore;
	
	@FindBy(how=How.XPATH, using = "//*[contains(@id,'ap1:showLessHeader')]")
    private WebElement lnkShowLess;
	 ...
	 @FindBy(how=How.XPATH, using = "//a[contains(@id,'pt1:ap1:accrualRevPeriodName::lovIconId')]")
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:accrualRevPeriodName::content')]")
	...
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'MAnt2:2:pt1:ap1:saveBatch::popEl')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:saveBatch::popEl')]")
	   private WebElement menuSave;
	 
	 //@FindBy(how=How.XPATH, using = "//*[contains(@id,'MAnt2:2:pt1:ap1:cmi4')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:cmi4')]")
...
// ShowMore link in Journal Section
	    ...
	    public boolean isshowLessLinkDisplayed(){
	 	   return SeleniumUtils.isDisplayed(driver, lnkShowLess, context.getReactTimeout());
	    } 
...
// search Reversal Period 
	    ...
	    public void clickReversalPeriodSearchIcon() throws InterruptedException{
	    	...
	    	SeleniumUtils.delay(2000);
	     	...
	     	wdwait.until(ExpectedConditions.visibilityOf(lnkRvsPeriodSearch));
	    ...
	    public void selectkReversalPeriodValue(String eventName){	
	    	WebDriverWait wait = new WebDriverWait(driver, 50);
	 	   WebElement eventLink = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='xup']//*[contains(text(), '"+eventName+"')]")));	   
	 	   //SeleniumUtils.delay(2000);
	 	   eventLink.click(); 
	 	   SeleniumUtils.delay(2000);
...
// Confirmation OK button
	    ...
	    public void clickSaveButton(){	
		  ...
		  //lstJournalDelete
		   ...
		   //lstSaveAndClose 
		    public ManageJournalsPage clickSaveAndCloseList() throws TestException{	
