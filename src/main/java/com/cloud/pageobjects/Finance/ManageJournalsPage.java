...
public class ManageJournalsPage extends BasePageObject{
	...
	@FindBy(how=How.XPATH, using = ".//*[contains(@id,'pt1:ap1:queryP:value00::content')]")
	...
	// @FindBy(how=How.XPATH, using = "//*[contains(@id,'accounting_journals:0:MAnt2:1:pt1:ap1:queryP:value10::content')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:queryP:value10::content')]")
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:queryP:value20::lovIconId')]")
	 ...
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:queryP:value30::content')]")
	   private WebElement inputSource;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:queryP:value40::content')]")
	   private WebElement inputCategory;
	 
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:queryP:value50::content')]")
	   private WebElement selectBatchStatus;
	 
	 //@FindBy(how=How.XPATH, using = "//*[contains(@id,'accounting_journals:0:MAnt2:1:pt1:ap1:queryP::search')]")
	 @FindBy(how=How.XPATH, using = "//*[contains(@id,'pt1:ap1:queryP::search')]")
	...
	// @FindBy(how=How.XPATH, using = " .//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_general_accounting_journals:0:MAnt2:1:pt1:ap1:AT1:_ATp:t1:0:commandLink3']")
	 @FindBy(how=How.XPATH, using = " .//*[contains(@id,'pt1:ap1:AT1:_ATp:t1:0:commandLink3')]")
	 ...
	 @FindBy(how=How.XPATH, using = ".//*[contains(@id,'pt1:ap1:AT1:_ATp:edit::icon')]")
	...
	// @FindBy(how=How.XPATH, using = ".//*[@id='_FOpt1:_FOr1:0:_FOSritemNode_general_accounting_journals:0:MAnt2:1:pt1:ap1:SPb']/a")
	 @FindBy(how=How.XPATH, using = ".//*[contains(@id,'pt1:ap1:SPb')]/a")
 ...
 // Search Button in Period Name
	 ...
	 // Search Ok button Accounting Period
	  ...
	  //Select Source list
	    public void selectSourceList(String strSource){
	    	SeleniumUtils.delay(2000);
	    	inputSource.clear();
	    	inputSource.click();
	    	inputSource.sendKeys(strSource);
	    	inputSource.sendKeys(Keys.ENTER);
	    	inputSource.click();
	 	   
	    }
	    
	    public boolean isSourceListDisplayed(){
		 	   return inputSource.isDisplayed();
		    }
	  //Select Category list
	    public void selectCategoryList(String strCategory){
	    	...
	    	inputCategory.clear();
	    	inputCategory.click();
	    	inputCategory.sendKeys(strCategory);
	    ...
	    public boolean isCategoryListDisplayed(){
		 	   return inputCategory.isDisplayed();
		    } 
	    
	    // Select BatchStatus
	    
	    public void selectBatchStatusList(String strBatchStatus){
	    	Select objSelect=new Select(selectBatchStatus);
	    	objSelect.selectByVisibleText(strBatchStatus);
	    	SeleniumUtils.delay(2000);
	 	   
	    }
	    
	    public boolean isBatchStatusListDisplayed(){
		 	   return selectBatchStatus.isDisplayed();
		    } 
// Search  button in Manage Journal Page
	    ...
	    public void clickJournalsSearchButton(){
	    	...
	    	JavascriptExecutor js = (JavascriptExecutor)driver;
	     	...
	     	wdwait.until(ExpectedConditions.visibilityOf(linkCell));
