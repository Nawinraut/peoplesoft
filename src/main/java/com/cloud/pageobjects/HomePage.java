...
public class HomePage extends BasePageObject {
	...
	//@FindBy(how=How.XPATH, using = "//*[@id='pt1:_UISmmLink::icon']|//*[@id='_FOpt1:_UISmmLink::icon']")
	...
	@FindBy(how=How.XPATH,using="//*[@id='pt1:nv_itemNode_manager_resources_CareerandPerformance']")
	private WebElement lnkCareerandPerformance;
	...
	@FindBy(how=How.XPATH,using="//*[contains(@id,'pt1:_UISatr:0:lView1')]")
	...
	@FindBy(how=How.XPATH,using="//*[@id='pt1:nv_itemNode_career_goals']|//*[@id='pt1:nv_itemNode_my_information_goals']|//*[@id='pt1:nv_itemNode_manager_resources_goals']")
	private WebElement lnkGoals;
	
	@FindBy(how=How.XPATH,using="//*[@id='pt1:nv_MANAGER_RESOURCES_HRA_HCMPERFORMANCE_FUSE_PERFORMANCE']")
	private WebElement lnkPerformance;
   ...
   // @FindBy(how=How.XPATH,using="//*[@id='pt1:nv_itemNode_tools_scheduled_processes']")
	...
	@FindBy(how=How.XPATH,using="//*[contains(@id,'pt1:nv_itemNode_tools_scheduled_processes')]")
//	@FindBy(how=How.XPATH,using="//*[@id='pt1:nvi_itemNode_tools_scheduled_processes_fuse_plus']");
	// @FindBy(xpath = "//a[contains(@title,'Scheduled Processes')]")
    ...
    @FindBy(how=How.XPATH,using="//*[@id='pt1:nv_itemNode_general_accounting_period_close']")
   	private WebElement lnkPeriodClose;

    @FindBy(how=How.XPATH,using="//a[contains(@id,'pt1:nv_itemNode_cash_management_cash_balances')]")
   	private WebElement lnkCashBalances;
    
    @FindBy(how=How.XPATH,using="//*[@id='pt1:nv_itemNode_my_information_expenses']")
   ...
   private List<WebElement> rowcount;
	...
	public void selectExpNotification(String strNotificationName)
	{	
		System.out.println("Pending Notifications is :"+listNotifications.getText());
		rowcount=(List<WebElement>) listNotifications.findElements(By.tagName("tr"));
		...
		for (int row=0;row<rownum;row++)
		{
			...
			WebElement cellNametext=driver.findElement(By.xpath(".//*[@id='pt1:_UISatr:0:lView1:"+row+":psl2::c']"));
			//*[@id="pt1:_UISatr:0:lView1:0:psl2::c"]
			String actualText=cellNametext.getText();
			//report.log(LogStatus.INFO, "Selected notification is "+actualText);
	 ...
	 public void clickNotificationsIcon()
	 {
		 	...
		 	wdwait.until(ExpectedConditions.visibilityOf(listNotifications));
			//SeleniumUtils.delay(5000);
...
//	     alert.accept();
	 ...
	 public CareerandPerformancePage clickCareerandPerformance() throws TestException{
			wdwait.until(ExpectedConditions.visibilityOf(lnkCareerandPerformance));
			lnkCareerandPerformance.click();
			report.log(LogStatus.INFO, "Step . Click the vertical scrollbar.");
			SeleniumUtils.scroll(driver, 0, 200);
			report.log(LogStatus.PASS, "Clicked on CareerandPerformance link");
			return new CareerandPerformancePage(driver,report);
		 }
	 ...
	 public PerformancePage clickPerformance() throws TestException{
			wdwait.until(ExpectedConditions.visibilityOf(lnkPerformance));
			lnkPerformance.click();
			report.log(LogStatus.PASS, "Clicked on Performance link");
	 ...
	 public ScheduledProcessesPage clickScheduledProcesses() throws TestException{
               ...
               // js.executeScript("arguments[0].click();",lnkMore);
                // lnkMore.click();
	 ...
	 public ScheduledProcessesPage clickScheduledProcessesLink() throws TestException{
  		 JavascriptExecutor js=(JavascriptExecutor) driver;
         wdwait.until(ExpectedConditions.visibilityOf(lnkMore));
         //js.executeScript("arguments[0].click();",lnkMore);
         lnkMore.click();
         ...
         SeleniumUtils.delay(5000);
         js.executeScript("arguments[0].click();",lnkScheduledProcesses);
         //lnkScheduledProcesses.click();
	 ...
	 public ExpensesPage clickExpenses() throws TestException{
			wdwait.until(ExpectedConditions.visibilityOf(lnkExpenses));
			lnkExpenses.click();
			report.log(LogStatus.PASS, "Clicked on Expenses link");
			return new ExpensesPage(driver,report);
		 }
	 
	 
	public CashBalancesPage clickCashBalancesLink() throws TestException{
			wdwait.until(ExpectedConditions.visibilityOf(lnkCashBalances));
			lnkCashBalances.click();
			report.log(LogStatus.PASS, "Clicked on Cash Balances link");
			return new CashBalancesPage(driver,report);
		 }
	 
	public PeriodClosePage clickPeriodCloseLink() throws TestException{
		wdwait.until(ExpectedConditions.visibilityOf(lnkPeriodClose));
		lnkPeriodClose.click();
		report.log(LogStatus.PASS, "Clicked on Period Close link");
		return new PeriodClosePage(driver,report);
	 } 
